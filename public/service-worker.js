...
precacheAndRoute([{
  "url": "index.js",
  "revision": "d71e8d6162ba87e12fb3577c193b7c02"
}, {
  "url": "manifest.json",
  "revision": "8883a310bae88522b1b808e03d7fd2c4"
}, {
  "url": "index.html",
  "revision": "5038177feb572d72f7c29ce17e3333bb"
}, {
  "url": "styles.css",
  "revision": "25460d906fcc2a6315a4479f2266af66"
}], {});
registerRoute("/share-target", async ({
  ...
  await cache.put( // TODO: Come up with a more meaningful cache key.
  `/images/${Date.now()}`, // TODO: Get more meaningful metadata and use it
  // to construct the response.
  new Response(formData.get('image'))); // After the POST succeeds, redirect to the main page.

  return Response.redirect('/', 303);
}, 'POST');
registerRoute(/\/images\/\d+/, new CacheOnly({
  "cacheName": "images",
  plugins: []
}), 'GET');
