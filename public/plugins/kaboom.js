var kaboom = (() => {
  ...
  var tt = (t, e, o) =>
      e in t
        ? Je(t, e, { enumerable: !0, configurable: !0, writable: !0, value: o })
        : (t[e] = o),
    le = (t, e) => {
      for (var o in e || (e = {})) en.call(e, o) && tt(t, o, e[o]);
      if (et) for (var o of et(e)) tn.call(e, o) && tt(t, o, e[o]);
      return t;
    },
    we = (t, e) => Qt(t, Jt(e));
  var r = (t, e) => Je(t, 'name', { value: e, configurable: !0 });
...
`);
  ...
  function Et() {
    ...
    function e(m) {
      return (
        m !== void 0 && (t.gainNode.gain.value = ae(m, Tt, St)),
    ...
    qt.exports = (
      ...
      function Ae(s) {
        ...
        let d = f(o.width(), o.height()),
          u = n.cam,
          p = ot(Pe(0, Math.PI * 2)).scale(u.shake);
