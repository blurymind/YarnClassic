  ...
  return (
    (n = {
        ...
        var o = (function() {
          function l(t, e) {
            ...
            (this.anchor = void 0),
              ...
              (this.limitHeight = !!e && e.limitHeight);
            var i = document.createElement('div');
            (i.className = 'jsoneditor-contextmenu-root'), (n.root = i);
            e = document.createElement('div');
            (e.className = 'jsoneditor-contextmenu'),
              (n.menu = e),
              i.appendChild(e);
            i = document.createElement('ul');
            (i.className = 'jsoneditor-menu'),
              e.appendChild(i),
              (n.list = i),
              (n.items = []);
            e = document.createElement('button');
            (e.type = 'button'), (n.focusButton = e);
            ...
            (n.style.overflow = 'hidden'),
                ...
                e.forEach(function(t) {
                  ...
                  'separator' === t.type
                    ? (((i = document.createElement('div')).className =
                      ...
                      (r = document.createElement('li')).appendChild(i),
                      d.appendChild(r))
                    : ((n = {}),
                      ...
                      t.submenu
                        ? (((r = document.createElement('div')).className =
                          ...
                          ((r = document.createElement('div')).className =
                            'jsoneditor-text' +
                            (t.click ? '' : ' jsoneditor-right-margin')),
                          r.appendChild(document.createTextNode(t.text)),
                          i.appendChild(r),
                          ((o = t.click
                            ? ((i.className += ' jsoneditor-default'),
                              ((a = document.createElement('button')).type =
                                'button'),
                              ((n.buttonExpand = a).className =
                                'jsoneditor-expand'),
                              ((r = document.createElement('div')).className =
                                'jsoneditor-expand'),
                              a.appendChild(r),
                              e.appendChild(a),
                              t.submenuTitle && (a.title = t.submenuTitle),
                              a)
                            : (((s = document.createElement('div')).className =
                                'jsoneditor-expand'),
                              i.appendChild(s),
                              i)).onclick = function(e) {
                            e.preventDefault(), h._onExpandItem(n), o.focus();
                          }),
                          (n.subItems = a = []),
                          (s = document.createElement('ul')),
                          ((n.ul = s).className = 'jsoneditor-menu'),
                          (s.style.height = '0'),
                          e.appendChild(s),
                          l(s, a, t.submenu))
                        : (((a = document.createElement('div')).className =
                          ...
                          ((a = document.createElement('div')).className =
                            'jsoneditor-text'),
                          a.appendChild(
                            document.createTextNode((0, u.Iu)(t.text))
                          ),
                          i.appendChild(a)),
                      c.push(n));
                });
              ...
              t.forEach(function(e) {
                ...
                h.maxHeight = Math.max(h.maxHeight, e);
              });
          }
          var e, t, n;
          return (
            ...
            (t = [
              {
                ...
                value: function() {
                  var t = [],
                    n = this;
                  return (
                    this.dom.items.forEach(function(e) {
                      t.push(e.button),
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  var i = !0,
                    ...
                    a = this;
                  (this.dom.absoluteAnchor = (0, d.w)(e, t, function() {
                    a.hide();
                  })),
                    r.bottom + this.maxHeight < o.bottom ||
                      (r.top - this.maxHeight > o.top && (i = !1));
                  n = n ? 0 : r.top - s.top;
                  i
                    ? ((s = e.offsetHeight),
                      (this.dom.menu.style.left = '0'),
                      (this.dom.menu.style.top = n + s + 'px'),
                      (this.dom.menu.style.bottom = ''))
                    : ((this.dom.menu.style.left = '0'),
                      (this.dom.menu.style.top = ''),
                      (this.dom.menu.style.bottom = '0px')),
                    this.limitHeight &&
                      ((o = i ? o.bottom - r.bottom - 10 : r.top - o.top - 10),
                      (this.dom.list.style.maxHeight = o + 'px'),
                      (this.dom.list.style.overflowY = 'auto')),
                    this.dom.absoluteAnchor.appendChild(this.dom.root),
                    (this.selection = (0, c.getSelection)()),
                    (this.anchor = e),
                    setTimeout(function() {
              ...
              },
              {
                ...
                value: function(n) {
                  ...
                  t &&
                    ...
                    setTimeout(function() {
                      o.expandedItem !== t &&
                        ((t.ul.style.display = ''), c.removeClassName)(
                          t.ul.parentNode,
                          'jsoneditor-selected'
                        );
                    }, 300),
                    ...
                    e ||
                      (((i = n.ul).style.display = 'block'),
                      i.clientHeight,
                      setTimeout(function() {
                        if (o.expandedItem === n) {
                          for (var e = 0, t = 0; t < i.childNodes.length; t++)
                            e += i.childNodes[t].clientHeight;
                          (i.style.height = e + 'px'),
                            (i.style.padding = '5px 10px');
                        }
                      }, 0),
                      (0, c.addClassName)(i.parentNode, 'jsoneditor-selected'),
                      (this.expandedItem = n));
                },
              },
              {
                ...
                value: function(e) {
                  var t,
                    ...
                    a = !1;
                  27 === s
                    ? (this.selection && (0, c.setSelection)(this.selection),
                    ...
                    ? e.shiftKey
                      ? 0 ===
                          (n = (t = this._getVisibleButtons()).indexOf(r)) &&
                        (t[t.length - 1].focus(), (a = !0))
                      : (n = (t = this._getVisibleButtons()).indexOf(r)) ===
                          t.length - 1 && (t[0].focus(), (a = !0))
                    : 37 === s
                    ...
                    ? ((n = (t = this._getVisibleButtons()).indexOf(r)),
                      (i =
                        (i =
                          (i = t[n - 1]) && 'jsoneditor-expand' === i.className
                            ? t[n - 2]
                            : i) || t[t.length - 1]) && i.focus(),
                      (a = !0))
                    : 39 === s
                    ? ((n = (t = this._getVisibleButtons()).indexOf(r)),
                      (o = t[n + 1]) &&
                    ...
                    : 40 === s &&
                      ...
                      (o =
                        (o =
                          (o = t[n + 1]) && 'jsoneditor-expand' === o.className
                            ? t[n + 2]
                            : o) || t[0]) && (o.focus(), (a = !0)),
                      (a = !0)),
        ...
        var i = (function() {
          function n(e) {
            !(function(e, t) {
              ...
              (this.errorTableVisible = e.errorTableVisible),
              (this.onToggleVisibility = e.onToggleVisibility),
              (this.onFocusLine = e.onFocusLine || function() {}),
              (this.onChangeHeight = e.onChangeHeight),
              (this.dom = {});
            var t = document.createElement('div');
            (t.className = 'jsoneditor-validation-errors-container'),
              (this.dom.validationErrorsContainer = t);
            e = document.createElement('div');
            (e.style.display = 'none'),
              (e.className = 'jsoneditor-additional-errors fadein'),
              (e.textContent = 'Scroll for more ▿'),
              (this.dom.additionalErrorsIndication = e),
              t.appendChild(e);
            e = document.createElement('span');
            (e.className = 'jsoneditor-validation-error-icon'),
              (e.style.display = 'none'),
              (this.dom.validationErrorIcon = e);
            e = document.createElement('span');
            (e.className = 'jsoneditor-validation-error-count'),
              (e.style.display = 'none'),
              (this.dom.validationErrorCount = e),
                ...
                value: function(e, a) {
                  ...
                  this.dom.validationErrors &&
                    ...
                    (this.dom.additionalErrorsIndication.style.display =
                      'none')),
                    this.errorTableVisible && 0 < e.length
                      ? (((n = document.createElement('div')).className =
                          'jsoneditor-validation-errors'),
                        ((t = document.createElement('table')).className =
                        ...
                        e.forEach(function(t) {
                          ...
                          (n.className = isNaN(e) ? '' : 'jump-to-line'),
                            'error' === t.type
                          ...
                          (i.style = 'white-space: nowrap;'),
                            (i.textContent = isNaN(e) ? '' : 'Ln ' + e),
                            n.appendChild(i),
                            'string' == typeof t
                              ? (((r = document.createElement(
                                  'td'
                                )).colSpan = 2),
                                (s = document.createElement('pre')).appendChild(
                                  document.createTextNode(t)
                                ),
                                r.appendChild(s),
                                n.appendChild(r))
                              : ((s = document.createElement('td')).appendChild(
                                  document.createTextNode(t.dataPath || '')
                                ),
                                n.appendChild(s),
                                (r = document.createElement('td')),
                                (s = document.createElement('pre')).appendChild(
                                  document.createTextNode(t.message)
                                ),
                                r.appendChild(s),
                                n.appendChild(r)),
                            (n.onclick = function() {
                        ...
                        (this.dom.validationErrors = n),
                        this.dom.validationErrorsContainer.appendChild(n),
                        (this.dom.additionalErrorsIndication.title =
                          e.length + ' errors total'),
                        ...
                        this.dom.validationErrorsContainer.scrollHeight
                          ? ((this.dom.additionalErrorsIndication.style.display =
                            ...
                            (this.dom.validationErrorsContainer.onscroll = function() {
                              d.dom.additionalErrorsIndication.style.display =
                                0 <
                                  d.dom.validationErrorsContainer
                                    .clientHeight &&
                                0 === d.dom.validationErrorsContainer.scrollTop
                                  ? 'block'
                                  : 'none';
                            }))
                          : (this.dom.validationErrorsContainer.onscroll = void 0),
                        (n =
                          this.dom.validationErrorsContainer.clientHeight +
                          (this.dom.statusBar
                            ? this.dom.statusBar.clientHeight
                            : 0)),
                        this.onChangeHeight(n))
                  ...
                  0 < n
                    ? ((this.dom.validationErrorCount.style.display = 'inline'),
                      (this.dom.validationErrorCount.innerText = n),
                      ...
                      (this.dom.validationErrorIcon.title =
                        n + ' schema validation error(s) found'),
                    ...
                    e.some(function(e) {
                      ...
                      ? ((e = e[0].line),
                        ...
                        (this.dom.parseErrorIndication.title = isNaN(e)
      ...
      474: function(e, t, n) {
        ...
        var i = (function() {
          function t(e) {
            ...
            (this.onFocus = 'function' == typeof e.onFocus ? e.onFocus : null),
              (this.onBlur = 'function' == typeof e.onBlur ? e.onBlur : null),
              (this._onClick = this._onEvent.bind(this)),
              (this._onKeyUp = function(e) {
                (9 !== e.which && 9 !== e.keyCode) || this._onEvent(e);
              }.bind(this)),
              (this.focusFlag = !1),
              (this.firstEventFlag = !0),
              (this.onFocus || this.onBlur) &&
            ...
            (n = [
              {
                ...
                value: function() {
                  document.removeEventListener('click', this._onClick),
                    ...
                    this._onEvent({ target: document.body });
                },
              },
              {
                key: '_onEvent',
                value: function(e) {
                  ...
                  e
                    ? this.focusFlag ||
                      ...
                      (this.focusFlag = !0))
                    : (this.focusFlag || this.firstEventFlag) &&
                      (this.onBlur &&
                        this.onBlur({ type: 'blur', target: this.target }),
                      (this.focusFlag = !1),
                      this.firstEventFlag && (this.firstEventFlag = !1));
                },
              },
            ]) && o(e.prototype, n),
            i && o(e, i),
      ...
      161: function(e, t, o) {
        ...
        var n = o(170),
          i = o(37),
          r = o(38).treeModeMixins,
          s = o(956).textModeMixins,
          a = o(341).previewModeMixins,
          l = o(791),
          d = l.clear,
          c = l.extend,
          h = l.getInnerText,
          u = l.getInternetExplorerVersion,
          p = l.parse,
          m = o(744).tryRequireAjv,
          f = o(558).showTransformModal,
          l = o(210).showSortModal,
          v = m();
        function g(e, t, n) {
          ...
          t &&
            ...
            t.onChangeJSON &&
              (('text' !== t.mode &&
                'code' !== t.mode &&
                (!t.modes ||
                  (-1 === t.modes.indexOf('text') &&
                    -1 === t.modes.indexOf('code')))) ||
                console.warn(
                  'Option "onChangeJSON" is not applicable to modes "text" and "code". Use "onChangeText" or "onChange" instead.'
                )),
            t &&
              Object.keys(t).forEach(function(e) {
                -1 === g.VALID_OPTIONS.indexOf(e) &&
                  console.warn(
                    'Unknown option "' + e + '". This option will be ignored'
                  );
              })),
        ...
        'undefined' == typeof Promise &&
          ...
          (g.modes = {}),
          (g.prototype.DEBOUNCE_INTERVAL = 150),
          (g.VALID_OPTIONS = [
            'ajv',
            'schema',
            'schemaRefs',
          ...
          (g.prototype._create = function(e, t, n) {
            (this.container = e),
              (this.options = t || {}),
              (this.json = n || {});
            n =
          ...
          (g.prototype.setMode = function(e) {
            if (e !== this.options.mode || !this.create) {
              ...
              n.mode = e;
              var o = g.modes[e];
              if (!o) throw new Error('Unknown mode "' + n.mode + '"');
              try {
                var r = 'text' === o.data,
                  s = this.getName(),
                  a = this[r ? 'getText' : 'get']();
                if (
                  (this.destroy(),
                  d(this),
                  c(this, o.mixin),
                  this.create(t, n),
                  this.setName(s),
                  this[r ? 'setText' : 'set'](a),
                  'function' == typeof o.load)
                )
                  try {
                    o.load.call(this);
                  } catch (e) {
                ...
                if ('function' == typeof n.onModeChange && e !== i)
                  try {
                    n.onModeChange(e, i);
                  } catch (e) {
                    console.error(e);
          ...
          (g.prototype._onError = function(e) {
            if (!this.options || 'function' != typeof this.options.onError)
              throw e;
            this.options.onError(e);
          }),
          (g.prototype.setSchema = function(e, t) {
            if (e) {
              var n;
              try {
                this.options.ajv
              ...
              if (n) {
                if (t) {
                  for (var i in t)
                    n.removeSchema(i), t[i] && n.addSchema(t[i], i);
                  this.options.schemaRefs = t;
                }
                (this.validateSchema = n.compile(e)),
          ...
          (g.registerMode = function(e) {
            var t;
            if (Array.isArray(e))
              for (o = 0; o < e.length; o++) g.registerMode(e[o]);
            else {
              ...
              var n = e.mode;
              if (n in g.modes)
                throw new Error('Mode "' + n + '" already registered');
              if ('function' != typeof e.mixin.create)
                throw new Error('Required function "create" missing on mixin');
              for (
                var i = ['setMode', 'registerMode', 'modes'], o = 0;
                o < i.length;
                o++
              )
                if ((t = i[o]) in e.mixin)
                  throw new Error(
                    'Reserved property "' + t + '" not allowed in mixin'
                  );
              g.modes[n] = e;
            }
          }),
        ...
        var o = (function() {
          function h(e, t, n, i) {
            ...
            for (
              var o = {
                  code: {
                    text: (0, p.Iu)('modeCodeText'),
                    title: (0, p.Iu)('modeCodeTitle'),
                    click: function() {
                      i('code');
                    },
                  },
                  form: {
                    text: (0, p.Iu)('modeFormText'),
                    title: (0, p.Iu)('modeFormTitle'),
                    click: function() {
                      i('form');
                    },
                  },
                  text: {
                    text: (0, p.Iu)('modeTextText'),
                    title: (0, p.Iu)('modeTextTitle'),
                    click: function() {
                      i('text');
                    },
                  },
                  tree: {
                    text: (0, p.Iu)('modeTreeText'),
                    title: (0, p.Iu)('modeTreeTitle'),
                    click: function() {
                      i('tree');
                    },
                  },
                  view: {
                    text: (0, p.Iu)('modeViewText'),
                    title: (0, p.Iu)('modeViewTitle'),
                    click: function() {
                      i('view');
                    },
                  },
                  preview: {
                    text: (0, p.Iu)('modePreviewText'),
                    title: (0, p.Iu)('modePreviewTitle'),
                    click: function() {
                      i('preview');
                    },
                  },
            ...
            (c.type = 'button'),
              (c.className = 'jsoneditor-modes jsoneditor-separator'),
              (c.textContent = d + ' ▾'),
              (c.title = (0, p.Iu)('modeEditorTitle')),
              (c.onclick = function() {
                new u.x(r).show(c, e);
              });
            d = document.createElement('div');
            (d.className = 'jsoneditor-modes'),
              (d.style.position = 'relative'),
              d.appendChild(c),
              e.appendChild(d),
              (this.dom = { container: e, box: c, frame: d });
          }
          var e, t, n;
          return (
            (e = h),
      ...
      170: function(e, t, n) {
        ...
        if (window.ace) i = window.ace;
          ...
          try {
            ...
            i.config.setModuleUrl('ace/mode/json_worker', o);
          } catch (e) {}
        e.exports = i;
      },
      864: function() {
          ...
          var e,
            t = {
              ...
              parse: function(e) {
                ...
                for (var u, p, m, f, v, g, y, b, x, C = {}; ; ) {
                  if (
                    ((m = n[n.length - 1]),
                    void 0 ===
                      (f =
                        this.defaultActions[m] ||
                        (null == u && (u = h()), r[m] && r[m][u])) ||
                      !f.length ||
                      !f[0])
                  ) {
                    if (!d) {
                    ...
                    if (3 == d) {
                      if (1 == u) throw new Error(T || 'Parsing halted.');
                      (l = this.lexer.yyleng),
                        (s = this.lexer.yytext),
                    ...
                    for (; !((2).toString() in r[m]); ) {
                      if (0 == m) throw new Error(T || 'Parsing halted.');
                      (x = 1),
                        (n.length = n.length - 2 * x),
                        (i.length = i.length - x),
                        (o.length = o.length - x),
                        (m = n[n.length - 1]);
                    }
          ...
          e = {
            ...
            next: function() {
              ...
              for (
                ...
                r < o.length &&
                (!(t = this._input.match(this.rules[o[r]])) ||
                  (e && !(t[0].length > e[0].length)) ||
                  ((e = t), (n = r), this.options.flex));
                r++
              );
              return e
      ...
      879: function(e) {
        ...
        (i.prototype = {
          ...
          (i.mixin = function(e) {
            for (var t = ['on', 'off', 'emit'], n = 0; n < t.length; n++)
              'function' == typeof e
                ? (e.prototype[t[n]] = i.prototype[t[n]])
                : (e[t[n]] = i.prototype[t[n]]);
            return e;
          });
        var c = {
          extend: function(e, t) {
          ...
          each: function(e, t, n) {
            if ('[object Object]' === Object.prototype.toString.call(e))
              ...
              for (var o = 0, r = e.length; o < r; o++) t.call(n, o, e[o], e);
          },
            ...
            if (t && '[object Object]' === Object.prototype.toString.call(t))
              for (n in t)
                n in r
                  ...
                  ? (r.textContent = t[n])
                  : 'text' === n
                  ? ((i = o.createTextNode(t[n])), r.appendChild(i))
          ...
          closest: function(e, t) {
            return (
              e &&
              e !== document.body &&
              (t(e) ? e : c.closest(e.parentNode, t))
            );
          },
          isInt: function(e) {
        ...
        function s(e, t, n) {
          e.parentNode
            ? e.parentNode.parentNode || t.appendChild(e.parentNode)
            : t.appendChild(e),
            c.removeClass(e, 'excluded'),
            n || (e.textContent = e.textContent + '');
        }
        function a() {
          var n, e;
          this.items.length &&
            ...
            this.config.pagination
              ? ((e = this.pages.slice(0, this.pageIndex)),
                c.each(
                  e,
                  function(e, t) {
                    c.each(
            ...
            n.childElementCount &&
              (c.removeClass(this.items[this.navIndex], 'active'),
              (this.navIndex = n.querySelector('.selectr-option').idx),
              c.addClass(this.items[this.navIndex], 'active')),
        ...
        function d(e, t) {
          return (
            ...
            this.items.push(t),
            e.defaultSelected && this.defaultSelected.push(e.idx),
            e.disabled && ((t.disabled = !0), c.addClass(t, 'disabled')),
            t
          );
        }
        function t() {
          (this.config.searchable || this.config.taggable) &&
            ...
            this.config.searchable &&
              c.removeClass(this.inputContainer, 'active'),
            c.hasClass(this.container, 'notice') &&
              (c.removeClass(this.container, 'notice'),
              c.addClass(this.container, 'open'),
              this.input.focus()),
            c.each(
              this.items,
              function(e, t) {
                c.removeClass(t, 'excluded'),
                  this.customOption || (t.textContent = t.textContent + '');
              },
              this
            ));
        }
        ...
        var r = function() {
          var n,
            e = this.tree,
            t = e.scrollTop;
          e.scrollHeight - e.offsetHeight <= t &&
        ...
        (o.prototype.render = function(e) {
          ...
          this.rendered ||
            ...
            (this.config.multiple || this.config.taggable) &&
              (this.el.multiple = !0),
            (this.disabled = l(this.config, 'disabled')),
            (this.opened = !1),
            ...
            function() {
              (this.requiresPagination =
                this.config.pagination && 0 < this.config.pagination),
                l(this.config, 'width') &&
                  (c.isInt(this.config.width)
                    ? (this.width = this.config.width + 'px')
                    : 'auto' === this.config.width
                    ? (this.width = '100%')
                    : c.includes(this.config.width, '%') &&
                      (this.width = this.config.width)),
                (this.container = c.createElement('div', {
                  class: 'selectr-container',
                })),
                this.config.customClass &&
                  c.addClass(this.container, this.config.customClass),
                this.mobileDevice
                  ? c.addClass(this.container, 'selectr-mobile')
                  : c.addClass(this.container, 'selectr-desktop'),
                (this.el.tabIndex = -1),
                this.config.nativeDropdown || this.mobileDevice
                  ? c.addClass(this.el, 'selectr-visible')
                  : c.addClass(this.el, 'selectr-hidden'),
                (this.selected = c.createElement('div', {
                  class: 'selectr-selected',
                  disabled: this.disabled,
                  tabIndex: 1,
                  'aria-expanded': !1,
                })),
                (this.label = c.createElement(
              ...
              (this.tree = c.createElement('ul', {
                class: 'selectr-options',
                role: 'tree',
                'aria-hidden': !0,
                'aria-expanded': !1,
              })),
                (this.notice = c.createElement('div', {
                  class: 'selectr-notice',
                })),
                this.el.setAttribute('aria-hidden', !0),
                this.disabled && (this.el.disabled = !0),
                this.el.multiple &&
                  (c.addClass(this.label, 'selectr-tags'),
                  c.addClass(this.container, 'multiple'),
                  (this.tags = []),
                  (this.selectedValues = this.getSelectedProperties('value')),
                  (this.selectedIndexes = this.getSelectedProperties('idx'))),
                this.selected.appendChild(this.label),
                this.config.clearable &&
                  ((this.selectClear = c.createElement('button', {
                    class: 'selectr-clear',
                    type: 'button',
                  })),
                  this.container.appendChild(this.selectClear),
                  c.addClass(this.container, 'clearable')),
                this.config.taggable &&
                  ((e = c.createElement('li', { class: 'input-tag' })),
                  (this.input = c.createElement('input', {
                  ...
                  c.addClass(this.container, 'taggable'),
                  (this.tagSeperators = [',']),
                ...
                this.config.searchable &&
                  ...
                  (this.inputClear = c.createElement('button', {
                    class: 'selectr-input-clear',
                    type: 'button',
                  })),
                  (this.inputContainer = c.createElement('div', {
              ...
              this.el.children.length &&
                    ...
                    'OPTGROUP' === t.nodeName
                      ? ((r = c.createElement('ul', {
                        ...
                        c.each(
                          t.children,
                          function(e, t) {
                            (t.idx = s), r.appendChild(d.call(this, t, r)), s++;
                          },
                          this
                        ))
                      : ((t.idx = s), d.call(this, t), s++);
                  },
                  this
                ),
                this.config.data &&
                  ...
                  c.each(
                    ...
                    function(e, t) {
                      l(t, 'children')
                        ? ((n = c.createElement('optgroup', { label: t.text })),
                          (r = c.createElement('ul', {
                            class: 'selectr-optgroup',
                            role: 'group',
                            html:
                          ...
                          c.each(
                            ...
                            function(e, t) {
                              ((i = new Option(
                                ...
                                t.value,
                                !1,
                                t.hasOwnProperty('selected') &&
                                  !0 === t.selected
                              )).disabled = l(t, 'disabled')),
                                this.options.push(i),
                                n.appendChild(i),
                                (i.idx = s),
                                r.appendChild(d.call(this, i, t)),
                                (this.data[s] = t),
                                s++;
                            },
                            this
                        ...
                        : (((i = new Option(
                            ...
                            t.value,
                            !1,
                            t.hasOwnProperty('selected') && !0 === t.selected
                          )).disabled = l(t, 'disabled')),
                          this.options.push(i),
                          (i.idx = s),
                          d.call(this, i, t),
                ...
                this.setSelected(!0);
              for (var a = (this.navIndex = 0); a < this.items.length; a++)
                if (((o = this.items[a]), !c.hasClass(o, 'disabled'))) {
                  c.addClass(o, 'active'), (this.navIndex = a);
                  break;
                }
              this.requiresPagination &&
                ...
                (this.placeEl = c.createElement('div', {
            ...
            this.bindEvents(),
            this.update(),
            (this.optsRect = c.rect(this.tree)),
            (this.rendered = !0),
          ...
          (o.prototype.bindEvents = function() {
            var i = this;
            (this.events = {}),
              (this.events.dismiss = function(e) {
                e = e.target;
                this.container.contains(e) ||
                  (!this.opened && !c.hasClass(this.container, 'notice')) ||
                  this.close();
              }.bind(this)),
              (this.events.navigate = function(e) {
                if (
                  ((e = e || window.event),
                  this.items.length &&
                    this.opened &&
                    c.includes([13, 38, 40], e.which))
                ) {
                  if ((e.preventDefault(), 13 === e.which))
                    return (
                      !(this.config.taggable && 0 < this.input.value.length) &&
                      this.change(this.navIndex)
                    );
                  var t,
                    n = this.items[this.navIndex];
                  switch (e.which) {
                    case 38:
                      (t = 0) < this.navIndex && this.navIndex--;
                      break;
                    case 40:
                      this.navIndex < this.items.length - (t = 1) &&
                        this.navIndex++;
                  }
                  for (
                    this.navigating = !0;
                    c.hasClass(this.items[this.navIndex], 'disabled') ||
                    c.hasClass(this.items[this.navIndex], 'excluded');

                  )
                    if (
                      (t ? this.navIndex++ : this.navIndex--, this.searching)
                    ) {
                  ...
                  e = c.rect(this.items[this.navIndex]);
                  t
                    ? (0 === this.navIndex
                    ...
                    : 0 === this.navIndex
                    ? (this.tree.scrollTop = 0)
                    : e.top - this.optsRect.top < 0 &&
                      (this.tree.scrollTop =
                        this.tree.scrollTop + (e.top - this.optsRect.top)),
                    n && c.removeClass(n, 'active'),
                    c.addClass(this.items[this.navIndex], 'active');
              ...
              (this.config.nativeDropdown || this.mobileDevice) &&
                (this.container.addEventListener('touchstart', function(e) {
                  e.changedTouches[0].target === i.el && i.toggle();
                }),
                (this.config.nativeDropdown || this.mobileDevice) &&
                  this.container.addEventListener('click', function(e) {
                    e.preventDefault(),
                      e.stopPropagation(),
                      e.target === i.el && i.toggle();
                  }),
                this.el.addEventListener('change', function(e) {
                  var t;
                  i.el.multiple
                    ? ((t = i.getSelectedProperties('idx')),
                      (t = (function(e, t) {
                        for (
                          var n, i = [], o = e.slice(0), r = 0;
                          r < t.length;
                          r++
                        )
                          -1 < (n = o.indexOf(t[r]))
                    ...
                    : -1 < i.el.selectedIndex && i.select(i.el.selectedIndex);
                })),
              this.config.nativeDropdown &&
                this.container.addEventListener('keydown', function(e) {
                  'Enter' === e.key &&
                    i.selected === document.activeElement &&
                    (i.toggle(),
                    setTimeout(function() {
                      i.el.focus();
                    }, 200));
              ...
              this.label.addEventListener('click', function(e) {
                c.hasClass(e.target, 'selectr-tag-remove') &&
                  i.deselect(e.target.parentNode.idx);
              }),
              this.selectClear &&
              ...
              this.tree.addEventListener('click', function(e) {
                ...
                e = c.closest(e.target, function(e) {
                  return e && c.hasClass(e, 'selectr-option');
                });
                e &&
                  (c.hasClass(e, 'disabled') ||
                    (c.hasClass(e, 'selected')
                      ? (i.el.multiple ||
                          (!i.el.multiple && i.config.allowDeselect)) &&
                        i.deselect(e.idx)
                      : i.select(e.idx),
                    i.opened && !i.el.multiple && i.close()));
              }),
              this.tree.addEventListener('mouseover', function(e) {
                c.hasClass(e.target, 'selectr-option') &&
                  (c.hasClass(e.target, 'disabled') ||
                    (c.removeClass(i.items[i.navIndex], 'active'),
                    c.addClass(e.target, 'active'),
                    (i.navIndex = [].slice.call(i.items).indexOf(e.target))));
              }),
              this.config.searchable &&
                ...
                this.inputClear.addEventListener('click', function(e) {
                  (i.input.value = null),
                    t.call(i),
                    i.tree.childElementCount || a.call(i);
                })),
              this.config.taggable &&
                this.input.addEventListener('keyup', function(e) {
                  var n;
                  i.search(),
                    i.config.taggable &&
                      this.value.length &&
                      ((n = this.value.trim()),
                      (13 !== e.which && !c.includes(i.tagSeperators, e.key)) ||
                        (c.each(i.tagSeperators, function(e, t) {
                          n = n.replace(t, '');
                        }),
                        i.add({ value: n, text: n, selected: !0 }, !0)
                          ? (i.close(), t.call(i))
                          : ((this.value = ''),
                            i.setMessage('That tag is already in use.'))));
                }),
              (this.update = c.debounce(function() {
                i.opened && i.config.closeOnScroll && i.close(),
                  i.width && (i.container.style.width = i.width),
                  i.invert();
              }, 50)),
              this.requiresPagination &&
                ((this.paginateItems = c.debounce(function() {
                  r.call(this);
                }, 50)),
          ...
          (o.prototype.destroy = function() {
            this.rendered &&
              ...
              c.removeClass(this.el, 'selectr-hidden'),
              this.el.form && c.off(this.el.form, 'reset', this.events.reset),
              c.off(document, 'click', this.events.dismiss),
              c.off(document, 'keydown', this.events.navigate),
              c.off(window, 'resize', this.update),
              c.off(window, 'scroll', this.update),
          ...
          (o.prototype.change = function(e) {
            var t = this.items[e],
              n = this.options[e];
            n.disabled ||
              (n.selected && c.hasClass(t, 'selected')
                ? this.deselect(e)
                : this.select(e),
              this.opened && !this.el.multiple && this.close());
          }),
          (o.prototype.select = function(i) {
            var e = this.items[i],
              t = [].slice.call(this.el.options),
              n = this.options[i];
            if (this.el.multiple) {
              if (c.includes(this.selectedIndexes, i)) return !1;
              if (
              ...
              this.selectedValues.push(n.value),
                this.selectedIndexes.push(i),
                function(e) {
                  var l,
                    d = this,
                    n = document.createDocumentFragment(),
                    t = this.options[e.idx],
                    i = this.data ? this.data[e.idx] : t,
                    o = this.customSelected
                      ? this.config.renderSelection(i)
                      : t.textContent,
                  ...
                  i.appendChild(o),
                    ...
                    this.config.sortSelected
                      ? ((t = this.tags.slice()),
                        (l = function(e, i) {
                          e.replace(/(\d+)|(\D+)/g, function(e, t, n) {
                            i.push([t || 1 / 0, n || '']);
                          });
                        }),
                        t.sort(function(e, t) {
                          var n,
                            ...
                            r = [];
                          for (
                            !0 === d.config.sortSelected
                              ? ((n = e.tag), (i = t.tag))
                              : 'text' === d.config.sortSelected &&
                                ((n = e.textContent), (i = t.textContent)),
                              l(n, o),
                              l(i, r);
                            o.length && r.length;
                            ...
                            var s = o.shift(),
                              a = r.shift(),
                              a = s[0] - a[0] || s[1].localeCompare(a[1]);
                            if (a) return a;
                          }
                      ...
                      : n.appendChild(i),
                    this.config.taggable
                      ? this.label.insertBefore(n, this.input.parentNode)
                      : this.label.appendChild(n);
                }.call(this, e);
            } else {
              var o = this.data ? this.data[i] : n;
              (this.label.textContent = this.customSelected
                ? this.config.renderSelection(o)
                : n.textContent),
            ...
            c.includes(t, n) || this.el.add(n),
              e.setAttribute('aria-selected', !0),
              c.addClass(e, 'selected'),
              c.addClass(this.container, 'has-selected'),
              (n.selected = !0),
              n.setAttribute('selected', ''),
              this.emit('selectr.change', n),
              this.emit('selectr.select', n);
          }),
          (o.prototype.deselect = function(e, t) {
            ...
            if (this.el.multiple) {
              ...
              o = this.selectedValues.indexOf(i.value);
              this.selectedValues.splice(o, 1),
                function(n) {
                  var i = !1;
                  c.each(
                    this.tags,
                    ...
                    i &&
                      (this.label.removeChild(i),
                      this.tags.splice(this.tags.indexOf(i), 1));
                }.call(this, n),
                this.tags.length ||
                  c.removeClass(this.container, 'has-selected');
            } else {
            ...
            this.items[e].setAttribute('aria-selected', !1),
              c.removeClass(this.items[e], 'selected'),
              (i.selected = !1),
              i.removeAttribute('selected'),
              this.emit('selectr.change', null),
              this.emit('selectr.deselect', i);
          }),
          (o.prototype.setValue = function(n) {
            var i = Array.isArray(n);
            if ((i || (n = n.toString().trim()), !this.el.multiple && i))
              return !1;
            c.each(
              this.options,
              function(e, t) {
                ((i && c.includes(n.toString(), t.value)) || t.value === n) &&
                  this.change(t.idx);
              },
              this
            );
                ...
                ? e
                  ? this.selectedIndexes.length &&
                    ...
                    c.each(
                      ...
                      function(e, t) {
                        t = this.options[t];
                        i.values[e] = { value: t.value, text: t.textContent };
                      },
                      this
                    ))
                  : (i = this.selectedValues.slice())
                : (i = e
                    ? {
                        value: (n = this.options[this.selectedIndex]).value,
                        text: n.textContent,
                      }
                    : this.selectedValue),
              (i = e && t ? JSON.stringify(i) : i)
            );
          }),
            ...
            if (n) {
              if (
                ...
                if (i) {
                  var o = !1;
                  if (
                    (c.each(this.options, function(e, t) {
                      t.value.toLowerCase() === n.value.toLowerCase() &&
                        (o = !0);
                    }),
                    o)
                  )
                ...
                var e = c.createElement('option', n);
                return (
                  this.data.push(n),
                  this.options.push(e),
                  (e.idx =
                    0 < this.options.length ? this.options.length - 1 : 0),
                  d.call(this, e),
                  n.selected && this.select(e.idx),
                  e
                );
              }
              return (
          ...
          (o.prototype.remove = function(n) {
            ...
            Array.isArray(n)
              ? c.each(
                  ...
                  function(e, t) {
                    c.isInt(t)
                      ? o.push(this.getOptionByIndex(t))
                      : 'string' == typeof n &&
                        o.push(this.getOptionByValue(t));
                  },
                  this
                )
              : c.isInt(n)
              ? o.push(this.getOptionByIndex(n))
              : 'string' == typeof n && o.push(this.getOptionByValue(n)),
              o.length &&
                (c.each(
                  o,
                  function(e, t) {
                    (i = t.idx), this.el.remove(t), this.options.splice(i, 1);
                    t = this.items[i].parentNode;
                    t && t.removeChild(this.items[i]),
                ...
                ? (c.each(
                    ...
                    function(e, t) {
                      ...
                      c.includes(
                        ...
                        ? (s(i, r, this.customOption),
                          c.removeClass(i, 'excluded'),
                          this.customOption ||
                            ((i.textContent = ''),
                            (n = (function(e, t) {
                              var n = new RegExp(e, 'i').exec(t);
                              if (n) {
                                (e = n.index), (n = n.index + n[0].length);
                                return {
                                  before: t.substring(0, e),
                                  match: t.substring(e, n),
                                  after: t.substring(n),
                                };
                              }
                              return null;
                            })(o, t.textContent)) &&
                              (i.appendChild(document.createTextNode(n.before)),
                              ((t = document.createElement('span')).className =
                                'selectr-match'),
                              t.appendChild(document.createTextNode(n.match)),
                              i.appendChild(t),
                              i.appendChild(document.createTextNode(n.after)))))
                        : c.addClass(i, 'excluded');
                    },
                    this
                  ),
                  r.childElementCount
                    ? ((e = this.items[this.navIndex]),
                      (t = r.firstElementChild),
                      c.removeClass(e, 'active'),
                      (this.navIndex = t.idx),
                      c.addClass(t, 'active'))
                    : this.config.taggable || this.setMessage('no results.'))
                : a.call(this),
              this.tree.appendChild(r));
          }),
          ...
          (o.prototype.open = function() {
            ...
            return (
              ...
              this.mobileDevice || this.config.nativeDropdown
                ? (c.addClass(this.container, 'native-open'),
                  void (
                    this.config.data &&
                    c.each(
                      this.options,
          ...
          (o.prototype.close = function() {
            ...
            this.opened && this.emit('selectr.close'),
              (this.opened = !1),
              this.mobileDevice || this.config.nativeDropdown
                ? c.removeClass(this.container, 'native-open')
                : ((e = c.hasClass(this.container, 'notice')),
                  this.config.searchable &&
                    !e &&
                    (this.input.blur(),
          ...
          (o.prototype.enable = function() {
            (this.disabled = !1),
              ...
              this.el.multiple &&
                c.each(this.tags, function(e, t) {
                  t.lastElementChild.tabIndex = 0;
                }),
              c.removeClass(this.container, 'selectr-disabled');
          }),
          (o.prototype.disable = function(e) {
            e || (this.el.disabled = !0),
              ...
              (this.disabled = !0),
              c.addClass(this.container, 'selectr-disabled');
          }),
          ...
          (o.prototype.clear = function(e) {
            ...
            this.el.multiple
              ...
              : -1 < this.selectedIndex && this.deselect(this.selectedIndex, e),
          ...
          (o.prototype.serialise = function(e) {
            ...
            return (
              c.each(this.options, function(e, t) {
                var n = { value: t.value, text: t.textContent };
                t.selected && (n.selected = !0),
                  t.disabled && (n.disabled = !0),
                  (i[e] = n);
              }),
              e ? JSON.stringify(i) : i
            );
          }),
          ...
          (o.prototype.setPlaceholder = function(e) {
            (e =
              ...
              this.options.length || (e = 'No options available'),
              (this.placeEl.textContent = e);
          }),
            ...
            if (this.items.length) {
              ...
              return (
                (this.pages = this.items
                  .map(function(e, t) {
                    return t % n.config.pagination == 0
                      ? n.items.slice(t, t + n.config.pagination)
                      : null;
                  })
                  .filter(function(e) {
                    return e;
          ...
          (o.prototype.setMessage = function(e, t) {
            t && this.close(),
              c.addClass(this.container, 'notice'),
          ...
          (o.prototype.invert = function() {
            var e = c.rect(this.selected),
              t = this.tree.parentNode.offsetHeight,
              n = window.innerHeight;
            e.top + e.height + t > n
              ? (c.addClass(this.container, 'inverted'), (this.isInverted = !0))
              : (c.removeClass(this.container, 'inverted'),
                (this.isInverted = !1)),
              (this.optsRect = c.rect(this.tree));
          }),
      ...
      602: function(e, t, n) {
        ...
        function i(n, e, i) {
          var t,
            ...
            r =
              'function' == typeof (l = n).getRootNode
                ? l.getRootNode()
                : window,
            s = {},
          ...
          function c() {
            if (d && d.parentNode) {
              for (var e in (d.parentNode.removeChild(d), s))
                (t = e),
                  Object.prototype.hasOwnProperty.call(s, t) &&
                    ((t = s[e]) && (0, u.removeEventListener)(r, e, t),
                    delete s[e]);
          ...
          function h(e) {
            (e = e.target) === d || (0, u.isChildOf)(e, d) || c();
          }
          return (
            (d.className = 'jsoneditor-anchor'),
            (d.style.position = 'absolute'),
            (d.style.left = a.left - l.left + 'px'),
            (d.style.top = a.top - l.top + 'px'),
            (d.style.width = a.width - 2 + 'px'),
            (d.style.height = a.height - 2 + 'px'),
            (d.style.boxSizing = 'border-box'),
            e.appendChild(d),
            (s.mousedown = (0, u.addEventListener)(r, 'mousedown', h)),
            (s.mousewheel = (0, u.addEventListener)(r, 'mousewheel', h)),
            o &&
              ((t = null),
        ...
        var t = n(987),
          r = {
            ...
            es: {
              ...
              actionsMenu:
                'Haga clic para abrir el menú de acciones (Ctrl + M)',
              ...
              autoType:
                'Field type "auto". The field type is automatically determined from the value and can be a string, number, boolean, or null.',
              objectType:
                'Tipo de campo "objeto".  Un objeto contiene un conjunto desordenado de pares clave/valor.',
              arrayType:
                'Tipo de campo "matriz".  Una matriz contiene una colección ordenada de valores.',
              stringType:
                'Tipo de campo "cadena".  El tipo de campo no se determina a partir del valor,  pero siempre se devuelve como una cadena.',
            ...
            'zh-CN': {
              ...
              stringType:
                '字段类型 "string". 字段类型由值自动确定，但始终作为字符串返回.',
              modeCodeText: '代码',
            ...
            'pt-BR': {
              ...
              openUrl:
                'Ctrl+Click ou Ctrl+Enter para abrir link em nova janela',
              undo: 'Desfazer último ação (Ctrl+Z)',
              validationCannotMove:
                'Não pode mover um campo como filho dele mesmo',
              autoType:
                'Campo do tipo "auto". O tipo do campo é determinao automaticamente a partir do seu valor e pode ser texto, número, verdade/falso ou nulo.',
              objectType:
                'Campo do tipo "objeto". Um objeto contém uma lista de pares com chave e valor.',
              arrayType:
                'Campo do tipo "lista". Uma lista contem uma coleção de valores ordenados.',
              stringType:
                'Campo do tipo "string". Campo do tipo nao é determinado através do seu valor, mas sempre retornara um texto.',
              examples: 'Exemplos',
              default: 'Revelia',
            ...
            tr: {
              ...
              autoType:
                'Alan tipi "otomatik". Alan türü otomatik olarak değerden belirlenirve bir dize, sayı, boolean veya null olabilir.',
              objectType:
              ...
              stringType:
                'Alan tipi "karakter dizisi". Alan türü değerden belirlenmez,ancak her zaman karakter dizisi olarak döndürülür.',
              modeCodeText: 'Kod',
            ...
            ja: {
              ...
              autoType:
                'オート： フィールドの型は値から自動的に決定されます。 (文字列・数値・ブール・null)',
              objectType:
            ...
            'fr-FR': {
              ...
              appendTitleAuto:
                "Ajouter un champ de type 'auto' (Ctrl+Shift+Ins)",
              ascending: 'Ascendant',
              ascendingTitle:
              ...
              validationCannotMove:
                'Cannot move a field into a child of itself',
              autoType:
                'Champe de type "auto". Ce type de champ est automatiquement déterminé en fonction de la valeur et peut être de type "chaîne", "nombre", "booléen" ou null.',
              objectType:
                'Champ de type "objet". Un objet contient un ensemble non ordonné de paires clé/valeur.',
              arrayType:
                'Champ de type "liste". Une liste contient une collection ordonnée de valeurs.',
              stringType:
                'Champ de type "chaîne". Ce type de champ n\'est pas déterminé en fonction de la valeur, mais retourne systématiquement une chaîne de caractères.',
            ...
            de: {
              ...
              drag:
                'Ziehen, um dieses Feld zu verschieben (Alt+Umschalt+Pfeile)',
            ...
            ru: {
              ...
              sortFieldTitle:
                'Выберите поле для сортировки массива или объекта',
              ...
              openUrl:
                'Ctrl+Click или Ctrl+Enter для открытия url в новом окне',
              undo: 'Отменить (Ctrl+Z)',
              validationCannotMove: 'Поле не может быть перемещено в потомка',
              autoType:
                'Тип поля автоматически определяется по значению и может быть строкой, числом, логическим значением или null.',
              objectType:
                'Объект содержит неупорядоченный набор пар ключ/значение.',
              arrayType: 'Массив содержит упорядоченный набор значений.',
              stringType:
                'Тип поля не определяется из значения, но всегда возвращается как строка.',
            ...
            for (var t in e)
              !(function(t) {
                i.find(function(e) {
                  ...
                  (r[t] = Object.assign({}, r[s], r[t], e[t]));
              })(t);
        }
        function c(e, t, n) {
          var i = r[(n = n || a)][e] || r[s][e] || e;
          if (t) for (var o in t) i = i.replace('${' + o + '}', t[o]);
          return i;
        }
      },
      56: function(e, t, n) {
        ...
        function o(e, t) {
          ...
          return (
            i
              ? ((t =
                  '@' !== i.field
                    ? ['0'].concat((0, s.parsePath)('.' + i.field))
                    : ['0']),
                (t =
                  'string' == typeof (0, s.get)(e, t)
                    ? i.value
                    : (0, s.parseString)(i.value)),
                (r +=
                  '[? ' +
                  i.field +
                  ' ' +
      ...
      987: function() {
        ...
        'undefined' != typeof Element &&
          (void 0 !== window.Element && e(window.Element.prototype),
          void 0 !== window.CharacterData && e(window.CharacterData.prototype),
          void 0 !== window.DocumentType && e(window.DocumentType.prototype)),
          Array.prototype.findIndex ||
            Object.defineProperty(Array.prototype, 'findIndex', {
              value: function(e) {
                for (var t = 0; t < this.length; t++) {
                  var n = this[t];
                  if (e.call(this, n, t, this)) return t;
                }
                return -1;
              },
              configurable: !0,
      ...
      341: function(e, t, n) {
              ...
              (t = [
                ...
                },
                {
                  ...
                  value: function() {
                    if (this.canUndo())
                      return (
                        this.index--, this.onChange(), this.items[this.index]
                      );
                  },
                },
                {
          ...
          t = {
            create: function(e) {
              ...
              void 0 === t.statusBar && (t.statusBar = !0),
                ...
                (t.createQuery = t.createQuery || c.r),
                (t.executeQuery = t.executeQuery || c.J),
                'number' == typeof (this.options = t).indentation
                  ? (this.indentation = Number(t.indentation))
                  : (this.indentation = 2),
                (0, d.cC)(this.options.languages),
                (0, d.m0)(this.options.language),
                (this.mode = 'preview');
              var n = this;
              (this.container = e),
                (this.dom = {}),
                (this.json = void 0),
                (this.text = ''),
                (this._debouncedValidate = (0, m.debounce)(
              ...
              (this.frameFocusTracker = new r.R(e)),
                ...
                this.options.mainMenuBar &&
                  ((0, m.addClassName)(this.content, 'has-main-menu-bar'),
                  (this.menu = document.createElement('div')),
                  (this.menu.className = 'jsoneditor-menu'),
                  this.frame.appendChild(this.menu),
                  ((e = document.createElement('button')).type = 'button'),
                  (e.className = 'jsoneditor-format'),
                  (e.title = (0, d.Iu)('formatTitle')),
                  ...
                  ((e = document.createElement('button')).type = 'button'),
                  (e.className = 'jsoneditor-compact'),
                  (e.title = (0, d.Iu)('compactTitle')),
                  this.menu.appendChild(e),
                  (e.onclick = function() {
                    n.executeWithBusyMessage(function() {
                      try {
                  ...
                  this.options.enableSort &&
                    (((e = document.createElement('button')).type = 'button'),
                    (e.className = 'jsoneditor-sort'),
                    (e.title = (0, d.Iu)('sortTitleShort')),
                    (e.onclick = function() {
                      n._showSortModal();
                    }),
                    this.menu.appendChild(e)),
                  this.options.enableTransform &&
                    (((i = document.createElement('button')).type = 'button'),
                    (i.title = (0, d.Iu)('transformTitleShort')),
                    (i.className = 'jsoneditor-transform'),
                    (i.onclick = function() {
                      n._showTransformModal();
                    }),
                    (this.dom.transform = i),
                    this.menu.appendChild(i)),
                  ((i = document.createElement('button')).type = 'button'),
                  (i.className = 'jsoneditor-repair'),
                  (i.title = (0, d.Iu)('repairTitle')),
                  this.menu.appendChild(i),
                  !(i.onclick = function() {
                    void 0 === n.json &&
                      n.executeWithBusyMessage(function() {
                    ...
                    ((i = document.createElement('button')).type = 'button'),
                    (i.className = 'jsoneditor-undo jsoneditor-separator'),
                    (i.title = (0, d.Iu)('undo')),
                    (i.onclick = function() {
                  ...
                  this.options &&
                    ...
                    (this.modeSwitcher = new h.x(
                      this.menu,
                      this.options.modes,
                      this.options.mode,
                      function(e) {
                        n.setMode(e), n.modeSwitcher.focus();
                      }
                    ))),
                (this.errorTable = new o.Q({
                  errorTableVisible: !0,
                  ...
                  onChangeHeight: function(e) {
                    e =
                      e +
                      (n.dom.statusBar ? n.dom.statusBar.clientHeight : 0) +
                      1;
                    (n.content.style.marginBottom = -e + 'px'),
                      (n.content.style.paddingBottom = e + 'px');
                  },
                })),
                ...
                t.statusBar &&
                  ((0, m.addClassName)(this.content, 'has-status-bar'),
                  (t = document.createElement('div')),
                  ((this.dom.statusBar = t).className = 'jsoneditor-statusbar'),
                  ...
                  t.appendChild(this.dom.fileSizeInfo),
                  ...
                  t.appendChild(this.dom.arrayInfo),
                  t.appendChild(this.errorTable.getErrorCounter()),
                  t.appendChild(this.errorTable.getWarningIcon()),
                  t.appendChild(this.errorTable.getErrorIcon())),
                this._renderPreview(),
                this.setSchema(this.options.schema, this.options.schemaRefs);
            },
            _renderPreview: function() {
              var e = this.getText();
              (this.dom.previewText.nodeValue = (0, m.limitCharacters)(
                e,
                s.WF
              )),
                this.dom.fileSizeInfo &&
                  (this.dom.fileSizeInfo.innerText =
                    'Size: ' + (0, m.formatSize)(e.length)),
                this.dom.arrayInfo &&
        ...
        (t._showSortModal = function() {
          ...
          this.executeWithBusyMessage(function() {
            var e = r.options.modalAnchor || s.qD,
              o = r.get();
            r._renderPreview(),
              (0, u.showSortModal)(
                e,
                o,
                function(i) {
                  r.executeWithBusyMessage(function() {
                    var e, t, n;
                    (e = o),
                      (t = i),
                      Array.isArray(e) &&
                        ((n = (0, m.sort)(e, t.path, t.direction)),
                        (r.sortedBy = t),
                        r._setAndFireOnChange(n)),
                      (0, m.isObject)(e) &&
                        ((e = (0, m.sortObjectKeys)(e, t.direction)),
                        (r.sortedBy = t),
                        r._setAndFireOnChange(e));
                  }, 'sorting...');
                },
                r.sortedBy
              );
          ...
          (t.get = function() {
            ...
            return (
              void 0 === this.json &&
                ((e = this.getText()), (this.json = (0, m.parse)(e))),
              this.json
            );
          }),
          (t.getText = function() {
            return (
              void 0 === this.text &&
                ...
                !0 === this.options.escapeUnicode &&
                  (this.text = (0, m.escapeUnicodeChars)(this.text))),
              this.text
            );
          }),
          ...
          (t._setText = function(e, t) {
            var n;
            !0 === this.options.escapeUnicode
              ? (this.text = (0, m.escapeUnicodeChars)(e))
              : (this.text = e),
              (this.json = t),
              this._renderPreview(),
              void 0 === this.json
                ? (n = this).executeWithBusyMessage(function() {
                    try {
                      (n.json = n.get()), n._renderPreview(), n._pushHistory();
                    } catch (e) {}
                  }, 'parsing...')
                : this._pushHistory(),
              this._debouncedValidate();
          ...
          (t._pushHistory = function() {
            var e;
            this.history &&
              ((e = { text: this.text, json: this.json }), this.history.add(e));
          }),
          (t.executeWithBusyMessage = function(e, t) {
            var n;
            this.getText().length > s.EX
              ? ((0, m.addClassName)((n = this).frame, 'busy'),
                (n.dom.busyContent.innerText = t),
                setTimeout(function() {
                  e(),
                    (0, m.removeClassName)(n.frame, 'busy'),
                    (n.dom.busyContent.innerText = '');
                }, 100))
              : e();
          }),
          (t.validate = n.validate),
          (t._renderErrors = n._renderErrors);
        var f = [{ mode: 'preview', mixin: t, data: 'json' }];
      },
      210: function(e, t, n) {
        'use strict';
        n.r(t),
        ...
        var t = n(483),
          ...
          r = n(791);
        function s(e, t, s, n) {
          var a = Array.isArray(t) ? (0, r.getChildPaths)(t) : [''],
            l = n && n.path && (0, r.contains)(a, n.path) ? n.path : a[0],
            d = (n && n.direction) || 'asc',
            n =
              ...
              (0, o.Iu)('sortFieldTitle') +
              '">    </select>  </div>  </td></tr><tr>  <td>' +
              (0, o.Iu)('sortDirectionLabel') +
              ' </td>  <td class="jsoneditor-modal-input">  <div id="direction" class="jsoneditor-button-group"><input type="button" value="' +
              (0, o.Iu)('sortAscending') +
              '" title="' +
              (0, o.Iu)('sortAscendingTitle') +
              '" data-value="asc" class="jsoneditor-button-first jsoneditor-button-asc"/><input type="button" value="' +
              (0, o.Iu)('sortDescending') +
              '" title="' +
              (0, o.Iu)('sortDescendingTitle') +
              '" data-value="desc" class="jsoneditor-button-last jsoneditor-button-desc"/>  </div>  </td></tr><tr><td colspan="2" class="jsoneditor-modal-input jsoneditor-modal-actions">  <input type="submit" id="ok" value="' +
              (0, o.Iu)('ok') +
          ...
          i()({
            ...
            overlayStyles: { backgroundColor: 'rgb(1,1,1)', opacity: 0.3 },
            modalClass: 'jsoneditor-modal jsoneditor-modal-sort',
          })
            .afterCreate(function(t) {
              var e = t.modalElem().querySelector('form'),
                n = t.modalElem().querySelector('#ok'),
                i = t.modalElem().querySelector('#field'),
                o = t.modalElem().querySelector('#direction');
              function r(e) {
                (o.value = e),
                  (o.className =
              ...
              a.forEach(function(e) {
                ...
                (n.onclick = function(e) {
                  e.preventDefault(),
                    e.stopPropagation(),
                    t.close(),
                    s({ path: i.value, direction: o.value });
                }),
                e && (e.onsubmit = n.onclick);
            })
        ...
        function a(e) {
          var t = e.container,
            ...
            n =
              ...
              '</th>        <td class="jsoneditor-jmespath-filter">          <div class="jsoneditor-inline jsoneditor-jmespath-filter-field" >            <select id="filterField">            </select>          </div>          <div class="jsoneditor-inline jsoneditor-jmespath-filter-relation" >            <select id="filterRelation">              <option value="==">==</option>              <option value="!=">!=</option>              <option value="<">&lt;</option>              <option value="<=">&lt;=</option>              <option value=">">&gt;</option>              <option value=">=">&gt;=</option>            </select>          </div>          <div class="jsoneditor-inline jsoneditor-jmespath-filter-value" >            <input type="text" class="value" placeholder="value..." id="filterValue" />          </div>        </td>      </tr>      <tr>        <th>' +
          ...
          i()({
            ...
            .afterCreate(function(t) {
              var e = t.modalElem(),
                ...
                d = e.querySelector('#sortOrder'),
                c = e.querySelector('#selectFields'),
                h = e.querySelector('#query'),
                u = e.querySelector('#preview');
              Array.isArray(w) ||
                ((n.style.fontStyle = 'italic'),
                (n.textContent =
                  '(wizard not available for objects, only for arrays)')),
                (0, k.getChildPaths)(x).forEach(function(e) {
                  var t = v(e),
                    e = document.createElement('option');
                  (e.text = t), (e.value = t), o.appendChild(e);
                  e = document.createElement('option');
                  (e.text = t), (e.value = t), l.appendChild(e);
                });
              var i = (0, k.getChildPaths)(x, !0).filter(function(e) {
                return '' !== e;
              });
              0 < i.length
                ? i.forEach(function(e) {
                    var t = v(e),
                      e = document.createElement('option');
                    (e.text = t), (e.value = t), c.appendChild(e);
                  })
                : (f = e.querySelector('#selectFieldsPart')) &&
              ...
              p.on('selectr.change', b),
                m.on('selectr.change', b),
                (a.oninput = b),
                n.on('selectr.change', b),
                i.on('selectr.change', b),
                f.on('selectr.change', b),
                (e.querySelector('.pico-modal-contents').onclick = function(e) {
                  'A' !== e.target.nodeName && e.preventDefault();
                });
              var g = (0, k.debounce)(function() {
                try {
                  var e = T(w, h.value);
                  (u.className = 'jsoneditor-transform-preview'),
                    (u.value =
                      ((t = e),
                      (n = 2),
                      (i = I.WF),
                      ...
                      (t = _(t, o, '', i)).length > i
                        ? ((o = t),
                          ('number' == typeof (i = i) ? o.slice(0, i) : o) +
                            '...')
                        : t)),
                    (r.disabled = !1);
                } catch (e) {
              ...
              function b() {
                ...
                if (
                  ...
                  l.value &&
                    d.value &&
                    (e.sort = { field: l.value, direction: d.value }),
                  c.value)
                ) {
                  for (var t, n = [], i = 0; i < c.options.length; i++)
                    c.options[i].selected &&
                      ((t = c.options[i].value), n.push(t));
                  e.projection = { fields: n };
                }
                y(x, e);
              }
              (h.oninput = g),
      ...
      956: function(e, t, n) {
        ...
        (n.create = function(e) {
          var t = this,
            n =
              1 < arguments.length && void 0 !== arguments[1]
                ? arguments[1]
                : {};
          void 0 === n.statusBar && (n.statusBar = !0),
            (n.mainMenuBar = !1 !== n.mainMenuBar),
            (n.enableSort = !1 !== n.enableSort),
            (n.enableTransform = !1 !== n.enableTransform),
            (n.createQuery = n.createQuery || f.r),
            (n.executeQuery = n.executeQuery || f.J),
            'number' == typeof (this.options = n).indentation
              ? (this.indentation = Number(n.indentation))
              : (this.indentation = 2),
            (0, m.cC)(this.options.languages),
            (0, m.m0)(this.options.language);
          var i = n.ace || h();
          (this.mode = 'code' === n.mode ? 'code' : 'text'),
            'code' === this.mode &&
              void 0 === i &&
              ((this.mode = 'text'),
              console.warn(
            ...
            (this.theme = n.theme || x),
            this.theme === x && i && (0, g.O)(),
            n.onTextSelectionChange &&
              this.onTextSelectionChange(n.onTextSelectionChange);
          var o = this;
          (this.container = e),
            (this.dom = {}),
            ...
            (this._debouncedValidate = (0, y.debounce)(
          ...
          (this.frameFocusTracker = new p.R(e)),
            (this.content = document.createElement('div')),
            (this.content.className = 'jsoneditor-outer'),
            this.options.mainMenuBar &&
              ((0, y.addClassName)(this.content, 'has-main-menu-bar'),
              (this.menu = document.createElement('div')),
              (this.menu.className = 'jsoneditor-menu'),
              this.frame.appendChild(this.menu),
              ((e = document.createElement('button')).type = 'button'),
              (e.className = 'jsoneditor-format'),
              (e.title = (0, m.Iu)('formatTitle')),
              this.menu.appendChild(e),
              (e.onclick = function() {
                try {
              ...
              this.options.enableSort &&
                (((e = document.createElement('button')).type = 'button'),
                (e.className = 'jsoneditor-sort'),
                (e.title = (0, m.Iu)('sortTitleShort')),
                (e.onclick = function() {
                  o._showSortModal();
                }),
                this.menu.appendChild(e)),
              this.options.enableTransform &&
                (((r = document.createElement('button')).type = 'button'),
                (r.title = (0, m.Iu)('transformTitleShort')),
                (r.className = 'jsoneditor-transform'),
                (r.onclick = function() {
                  o._showTransformModal();
                }),
                this.menu.appendChild(r)),
              ((r = document.createElement('button')).type = 'button'),
              (r.className = 'jsoneditor-repair'),
              (r.title = (0, m.Iu)('repairTitle')),
              this.menu.appendChild(r),
              (r.onclick = function() {
                try {
                  o.repair(), o._onChange();
                } catch (e) {
                  o._onError(e);
                }
              }),
              'code' === this.mode &&
                (((c = document.createElement('button')).type = 'button'),
                (c.className = 'jsoneditor-undo jsoneditor-separator'),
                (c.title = (0, m.Iu)('undo')),
                (c.onclick = function() {
                  t.aceEditor
                    .getSession()
              ...
              'code' === this.mode &&
                ((s = document.createElement('a')).appendChild(
                  document.createTextNode('powered by ace')
                ),
                (s.href = 'https://ace.c9.io/'),
                (s.target = '_blank'),
                (s.className = 'jsoneditor-poweredBy'),
                (s.onclick = function() {
                  window.open(s.href, s.target, 'noopener');
                }),
          ...
          var a,
            ...
            c =
              ...
              b('function' === this.options.onEditable) &&
              !this.options.onEditable({});
          this.frame.appendChild(this.content),
            this.container.appendChild(this.frame),
            'code' === this.mode
              ? ((this.editorDom = document.createElement('div')),
                ...
                (i = (l = i.edit(this.editorDom)).getSession()),
                (l.$blockScrolling = 1 / 0),
                l.setTheme(this.theme),
                l.setOptions({ readOnly: c }),
                l.setShowPrintMargin(!1),
                l.setFontSize('13px'),
                i.setMode('ace/mode/json'),
                i.setTabSize(this.indentation),
                i.setUseSoftTabs(!0),
                i.setUseWrapMode(!0),
                (a = i.setAnnotations),
                (i.setAnnotations = function(e) {
                  a.call(this, e && e.length ? e : o.annotations);
                }),
                l.commands.bindKey('Ctrl-L', null),
                l.commands.bindKey('Command-L', null),
                l.commands.bindKey('Ctrl-\\', null),
                l.commands.bindKey('Command-\\', null),
                l.commands.bindKey('Ctrl-Shift-\\', null),
                l.commands.bindKey('Command-Shift-\\', null),
                (this.aceEditor = l).on('change', this._onChange.bind(this)),
                l.on('changeSelection', this._onSelect.bind(this)))
              : (((d = document.createElement('textarea')).className =
                  'jsoneditor-text'),
                (d.spellcheck = !1),
                this.content.appendChild(d),
                (this.textarea = d),
                (this.textarea.readOnly = c),
                null === this.textarea.oninput
                  ? (this.textarea.oninput = this._onChange.bind(this))
                  : (this.textarea.onchange = this._onChange.bind(this)),
                (d.onselect = this._onSelect.bind(this)),
                (d.onmousedown = this._onMouseDown.bind(this)),
                (d.onblur = this._onBlur.bind(this))),
            this._updateHistoryButtons(),
            (this.errorTable = new u.Q({
              ...
              onChangeHeight: function(e) {
                e =
                  e + (o.dom.statusBar ? o.dom.statusBar.clientHeight : 0) + 1;
                (o.content.style.marginBottom = -e + 'px'),
                  (o.content.style.paddingBottom = e + 'px');
              },
            })),
            this.frame.appendChild(this.errorTable.getErrorTable()),
            n.statusBar &&
              ((0, y.addClassName)(this.content, 'has-status-bar'),
              (this.curserInfoElements = {}),
              (l = document.createElement('div')),
              ((this.dom.statusBar = l).className = 'jsoneditor-statusbar'),
              this.frame.appendChild(l),
              ...
              l.appendChild(n),
              l.appendChild(c),
              (this.curserInfoElements.colVal = c),
              (this.curserInfoElements.lnVal = d),
              ((c = document.createElement('span')).className =
                'jsoneditor-curserinfo-label'),
              (c.innerText = 'characters selected'),
              (c.style.display = 'none'),
              ((d = document.createElement('span')).className =
                'jsoneditor-curserinfo-count'),
              (d.innerText = '0'),
              (d.style.display = 'none'),
              (this.curserInfoElements.countLabel = c),
              (this.curserInfoElements.countVal = d),
              l.appendChild(d),
              l.appendChild(c),
              l.appendChild(this.errorTable.getErrorCounter()),
              l.appendChild(this.errorTable.getWarningIcon()),
              l.appendChild(this.errorTable.getErrorIcon())),
            this.setSchema(this.options.schema, this.options.schemaRefs);
        }),
          ...
          (n._updateHistoryButtons = function() {
            var e;
            this.aceEditor &&
              this.dom.undo &&
              this.dom.redo &&
              (e = this.aceEditor.getSession().getUndoManager()) &&
              e.hasUndo &&
              e.hasRedo &&
              ((this.dom.undo.disabled = !e.hasUndo()),
              (this.dom.redo.disabled = !e.hasRedo()));
          }),
          (n._showSortModal = function() {
            var n = this,
              e = this.options.modalAnchor || s.qD,
              i = this.get();
            (0, o.showSortModal)(
              e,
              i,
              function(e) {
                var t;
                Array.isArray(i) &&
                  ((t = (0, y.sort)(i, e.path, e.direction)),
                  (n.sortedBy = e),
                  n.update(t)),
                  (0, y.isObject)(i) &&
                    ((t = (0, y.sortObjectKeys)(i, e.direction)),
                    (n.sortedBy = e),
                    n.update(t));
              },
              n.sortedBy
          ...
          (n._showTransformModal = function() {
            var t = this,
              e = this.options,
              n = e.modalAnchor,
              i = e.createQuery,
          ...
          (n._onSelect = function() {
            this._updateCursorInfo(), this._emitSelectionChange();
          }),
          (n._onKeyDown = function(e) {
            var t = !1;
            73 === (e.which || e.keyCode) &&
              e.ctrlKey &&
              (e.shiftKey ? this.compact() : this.format(),
              this._onChange(),
              (t = !0)),
          ...
          (n._onMouseDown = function() {
            this._updateCursorInfo(), this._emitSelectionChange();
          }),
          (n._onBlur = function() {
            var e = this;
            setTimeout(function() {
              e.isFocused || (e._updateCursorInfo(), e._emitSelectionChange()),
                (e.isFocused = !1);
            });
          }),
          (n._updateCursorInfo = function() {
            var e,
              t,
              n,
              i,
              ...
              r = this;
            function s() {
              r.curserInfoElements.countVal.innerText !== o &&
                ((r.curserInfoElements.countVal.innerText = o),
                (r.curserInfoElements.countVal.style.display = o
                  ? 'inline'
                  : 'none'),
                (r.curserInfoElements.countLabel.style.display = o
                  ? 'inline'
                  : 'none')),
                (r.curserInfoElements.lnVal.innerText = n),
                (r.curserInfoElements.colVal.innerText = i);
            }
            this.textarea
              ? setTimeout(function() {
                  var e = (0, y.getInputSelection)(r.textarea);
                  e.startIndex !== e.endIndex &&
                    (o = e.endIndex - e.startIndex),
                    (i =
                      o &&
                      r.cursorInfo &&
                      r.cursorInfo.line === e.end.row &&
                      r.cursorInfo.column === e.end.column
                        ? ((n = e.start.row), e.start.column)
                        : ((n = e.end.row), e.end.column)),
                    (r.cursorInfo = { line: n, column: i, count: o }),
                    r.options.statusBar && s();
                }, 0)
              : this.aceEditor &&
                this.curserInfoElements &&
                ((e = this.aceEditor.getCursorPosition()),
                (t = this.aceEditor.getSelectedText()),
                (n = e.row + 1),
                (i = e.column + 1),
                (o = t.length),
                (r.cursorInfo = { line: n, column: i, count: o }),
          ...
          (n._setText = function(e, t) {
            var n,
              i = this,
              e =
                !0 === this.options.escapeUnicode
                  ? (0, y.escapeUnicodeChars)(e)
                  : e;
          ...
          (n.validate = function() {
            ...
            try {
              var r = this.get();
              this.validateSchema &&
                (this.validateSchema(r) ||
                  (i = this.validateSchema.errors.map(function(e) {
                    return (
                      (e.type = 'validation'), (0, y.improveSchemaError)(e)
                    );
                  }))),
              ...
              return (function(e, t) {
                ...
                try {
                  var n = t(e);
                  return ((0, y.isPromise)(n) ? n : Promise.resolve(n)).then(
                    function(e) {
                      return Array.isArray(e)
                        ? e
                            .filter(function(e) {
                              var t = (0, y.isValidValidationError)(e);
                              return (
                                t ||
                                  console.warn(
                            ...
                            .map(function(e) {
                              return {
                                dataPath: (0, y.stringifyPath)(e.path),
                                message: e.message,
                ...
                return (
                  a === s.validationSequence &&
                    ((e = i.concat(o).concat(e)),
                    s._renderErrors(e),
                    'function' == typeof n.options.onValidationError &&
                      (0, y.isValidationErrorChanged)(e, n.lastSchemaErrors) &&
                      n.options.onValidationError.call(n, e),
                    (n.lastSchemaErrors = e)),
                  n.lastSchemaErrors
                );
              });
            } catch (e) {
              return (
                this.getText() &&
                  ((r = /\w*line\s*(\d+)\w*/g.exec(e.message)) && (t = +r[1]),
                  (o = [
                    {
                      type: 'error',
                ...
                this._renderErrors(o),
                'function' == typeof this.options.onValidationError &&
                  (0, y.isValidationErrorChanged)(o, this.lastSchemaErrors) &&
                  this.options.onValidationError.call(this, o),
                (this.lastSchemaErrors = o),
                Promise.resolve(this.lastSchemaErrors)
              );
            }
          }),
          (n._validateAndCatch = function() {
            this.validate().catch(function(e) {
              console.error('Error running validation:', e);
            });
          }),
          (n._renderErrors = function(i) {
            var e = this.getText(),
              t = [];
            i.reduce(function(e, t) {
              return (
                'string' == typeof t.dataPath &&
                  -1 === e.indexOf(t.dataPath) &&
                  e.push(t.dataPath),
                e
              );
            }, t);
            t = (0, y.getPositionForPath)(e, t);
            this.aceEditor &&
              ((this.annotations = t.map(function(t) {
              ...
              this.errorTable.setErrors(i, t),
              this.aceEditor && this.aceEditor.resize(!1);
          }),
          (n.getTextSelection = function() {
            var e = {};
            if (this.textarea) {
              var t = (0, y.getInputSelection)(this.textarea);
              return (
                this.cursorInfo &&
                this.cursorInfo.line === t.end.row &&
                this.cursorInfo.column === t.end.column
            ...
            if (this.aceEditor) {
              var n = this.aceEditor.getSelection(),
                i = this.aceEditor.getSelectedText(),
                t = n.getRange(),
                n = n.getSelectionLead();
              return (
                n.row === t.end.row && n.column === t.end.column
                  ? (e = t)
                  : ((e.start = t.end), (e.end = t.start)),
                {
                  start: { row: e.start.row + 1, column: e.start.column + 1 },
                  end: { row: e.end.row + 1, column: e.end.column + 1 },
                  text: i,
                }
              );
            }
          }),
          (n.onTextSelectionChange = function(e) {
            'function' == typeof e &&
              (this._selectionChangedHandler = (0, y.debounce)(
                e,
                this.DEBOUNCE_INTERVAL
              ));
          }),
          (n.setTextSelection = function(e, t) {
            var n, i, o;
            e &&
              t &&
              (this.textarea
                ? ((n = (0, y.getIndexForPosition)(
                    this.textarea,
                    e.row,
                    e.column
                  )),
                  (i = (0, y.getIndexForPosition)(
                    this.textarea,
                    t.row,
                    t.column
                  )),
                  -1 < n &&
                    ...
                    (this.textarea.setSelectionRange
                      ? (this.textarea.focus(),
                        this.textarea.setSelectionRange(n, i))
                      : this.textarea.createTextRange &&
                        ((o = this.textarea.createTextRange()).collapse(!0),
                        o.moveEnd('character', i),
                        o.moveStart('character', n),
                        o.select()),
                    (o = (this.textarea.value.match(/\n/g) || []).length + 1),
                    (o = this.textarea.scrollHeight / o),
                    (o = e.row * o),
                    (this.textarea.scrollTop =
                      o > this.textarea.clientHeight
                        ? o - this.textarea.clientHeight / 2
                        : 0)))
                : this.aceEditor &&
                  ((t = {
                    start: { row: e.row - 1, column: e.column - 1 },
                    end: { row: t.row - 1, column: t.column - 1 },
                  }),
                  this.aceEditor.selection.setRange(t),
                  this.aceEditor.scrollToLine(e.row - 1, !0)));
          });
        var l = [
          { mode: 'text', mixin: n, data: 'text', load: r },
          { mode: 'code', mixin: n, data: 'text', load: r },
        ];
      },
      38: function(e, t, n) {
        'use strict';
            ...
            !(function(e, t) {
              ...
              t && t instanceof Object
                ? (this.setField(t.field, t.fieldEditable),
                  'value' in t && this.setValue(t.value, t.type),
                  'internalValue' in t &&
                    this.setInternalValue(t.internalValue))
                : (this.setField(''), this.setValue(null)),
              (this._debouncedOnChangeValue = (0, I.debounce)(
                this._onChangeValue.bind(this),
                k.prototype.DEBOUNCE_INTERVAL
              )),
              (this._debouncedOnChangeField = (0, I.debounce)(
          ...
          return (
            ...
            (t = [
                  ...
                  (this.editable = { field: !0, value: !0 }),
                    this.editor &&
                      ...
                      ('tree' !== this.editor.options.mode &&
                        ...
                        ('boolean' ==
                        typeof (e = this.editor.options.onEditable({
                          field: this.field,
                          value: this.value,
                          path: this.getPath(),
                        }))
                  ...
                  for (
                    ...
                    !(function() {
                      ...
                      if ('number' == typeof t) {
                        ...
                        if ('object' !== i.type)
                          throw new Error(
                            'Cannot get child node ' + t + ': node is no object'
                          );
                  ...
                  if (i && this.dom && this.dom.tr) {
                    (0, I.addClassName)(
                      ...
                      e ||
                        ...
                        (this.dom.tdError = e),
                        this.dom.tdValue.parentNode.appendChild(e));
                    ...
                    var t = function() {
                      ...
                      s = function(e) {
                        ...
                        n.dom.popupAnchor = (0, h.w)(
                          o,
                          n.editor.getPopupAnchor(),
                          r,
                          e
                        );
                        (e = o.getBoundingClientRect()),
                          (t =
                            120 < t.getBoundingClientRect().width - e.x
                              ? 'jsoneditor-above'
                              : 'jsoneditor-left'),
                          (e = document.createElement('div'));
                        (e.className = 'jsoneditor-popover ' + t),
                          e.appendChild(document.createTextNode(i.message)),
                          n.dom.popupAnchor.appendChild(e);
                      };
              ...
              },
              {
                ...
                value: function() {
                  return (
                    void 0 === this.field && this._getDomField(), this.field
                  );
                },
              },
              {
                ...
                value: function(e, t) {
                  ...
                  if ('array' === this.type) {
                    for (
                      ...
                      void 0 === (s = e[n]) ||
                        ...
                        (n < this.childs.length
                          ? (((o = this.childs[n]).fieldEditable = !1),
                            (o.index = n),
                            o.setValue(s))
                          : ((o = new k(this.editor, { value: s })),
                            (r = n < this.getMaxVisibleChilds()),
                            this.appendChild(o, r, !1)));
                    for (i = this.childs.length; i >= e.length; i--)
                      this.removeChild(this.childs[i], !1);
                    ...
                    for (
                      ...
                      x(e, this.childs[i].field) ||
                        this.removeChild(this.childs[i], !1);
                    for (var d in ((n = 0), e))
                      x(e, d) &&
                        (void 0 === (s = e[d]) ||
                          s instanceof Function ||
                          ((a = this.findChildByProperty(d))
                            ? (a.setField(d, !0), a.setValue(s))
                            : ((a = new k(this.editor, { field: d, value: s })),
                              (d = n < this.getMaxVisibleChilds()),
                              this.appendChild(a, d, !1))),
                        n++);
                    !(this.value = '') === this.editor.options.sortObjectKeys &&
                      this.sort([], 'asc', !1);
                  } else
                    this.hideChilds(),
                      delete this.append,
                      ...
                      delete this.childs,
                      (this.value = e);
                  Array.isArray(l) !== Array.isArray(this.childs) &&
                    this.recreateDom(),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (((this.type = e.type), 'array' === e.type)) {
                    for (
                      this.childs || (this.childs = []), o = 0;
                      o < e.childs.length;
                      o++
                    )
                      void 0 === (t = e.childs[o]) ||
                        t instanceof Function ||
                        (o < this.childs.length
                          ? (((n = this.childs[o]).fieldEditable = !1),
                            (n.index = o),
                            n.setInternalValue(t))
                          : ((n = new k(this.editor, { internalValue: t })),
                            (i = o < this.getMaxVisibleChilds()),
                            this.appendChild(n, i, !1)));
                    ...
                    for (
                      ...
                      void 0 === (t = e.childs[o]) ||
                        t instanceof Function ||
                        (o < this.childs.length
                          ? (delete (n = this.childs[o]).index,
                            n.setField(t.field, !0),
                            n.setInternalValue(t.value))
                          : ((n = new k(this.editor, {
                              field: t.field,
                    ...
                    this.hideChilds(),
                      ...
                      delete this.childs,
                      (this.value = e.value);
                  Array.isArray(s) !== Array.isArray(this.childs) &&
                    this.recreateDom(),
                    this.updateDom({ updateIndexes: !0 }),
                    (this.previousValue = this.value);
                },
              },
              {
                ...
                value: function() {
                  var e;
                  this.dom && this.dom.tr && this.dom.tr.parentNode
                    ? ((e = this._detachFromDom()),
                      this.clearDom(),
                      this._attachToDom(e))
                    : this.clearDom();
                },
              },
              {
                ...
                value: function() {
                  ...
                  if ('object' !== this.type)
                    return (
                      void 0 === this.value && this._getDomValue(), this.value
                    );
                  var n = {};
                  return (
                    this.childs.forEach(function(e) {
                  ...
                  if (e && this.expanded) {
                    ...
                    if (n) {
                      ...
                      for (
                        ...
                        var s = this.childs[r];
                        s.getDom().parentNode || n.insertBefore(s.getDom(), o),
                          s.showChilds();
                      }
                      e = this.getShowMoreDom();
                      (o = this._getNextTr()),
                        e.parentNode || n.insertBefore(e, o),
              ...
              },
              {
                key: '_getNextTr',
                value: function() {
                  return this.showMore && this.showMore.getDom().parentNode
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  this.childs &&
                    this.expanded &&
                    ((t = this.getAppendDom()).parentNode &&
                      t.parentNode.removeChild(t),
                    this.childs.forEach(function(e) {
                      e.hide();
                    }),
                    (t = this.getShowMoreDom()).parentNode &&
                      t.parentNode.removeChild(t),
                    (e && !e.resetVisibleChilds) ||
                      (this.visibleChilds = this.getMaxVisibleChilds()));
                },
              },
              {
                ...
                value: function() {
                  ...
                  this.dom.field &&
                    this.editor &&
                    this.editor.options &&
                    'function' == typeof this.editor.options.onClassName &&
                    this.dom.tree &&
                    ((0, I.removeAllClassNames)(this.dom.tree),
                    (e =
                ...
                value: function(e, t, n) {
                  ...
                  this._hasChilds() &&
                    ...
                    this.expanded &&
                      !1 !== t &&
                      ((i = e.getDom()),
                      (t = (o = this._getNextTr()) ? o.parentNode : void 0),
                      o && t && t.insertBefore(i, o),
                      e.showChilds(),
                      this.visibleChilds++),
                    !1 !== n &&
                      (this.updateDom({ updateIndexes: !0 }),
                ...
                value: function(e, t, n) {
                  ...
                  this._hasChilds() &&
                    ((i = this.dom.tr ? this.dom.tr.parentNode : void 0) &&
                      (((o = document.createElement('tr')).style.height =
                        i.clientHeight + 'px'),
                      i.appendChild(o)),
                    e.parent && e.parent.removeChild(e),
                    t instanceof A || !t
                      ? this.childs.length + 1 > this.visibleChilds
                        ? ((r = this.childs[this.visibleChilds - 1]),
                          this.insertBefore(e, r, n))
                        : this.appendChild(e, !0, n)
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  if (this._hasChilds()) {
                    ...
                    this.expanded &&
                      ((o = e.getDom()),
                      (t = (i = t.getDom()) ? i.parentNode : void 0),
                      i && t && t.insertBefore(o, i),
                      e.showChilds(),
                      this.showChilds()),
                      !1 !== n &&
                        (this.updateDom({ updateIndexes: !0 }),
              ...
              },
              {
                ...
                value: function(t, n) {
                  ...
                  return (
                    ...
                    void 0 !== this.field &&
                      n.length <= this.MAX_SEARCH_RESULTS &&
                      (-1 !==
                        String(this.field)
                          .toLowerCase()
                          .indexOf(e) &&
                  ...
                  for (var e = this; e && e.parent; ) {
                    for (
                      var t =
                        'array' === e.parent.type
                          ? e.index
                          : e.parent.childs.indexOf(e);
                      e.parent.visibleChilds < t + 1;
                    ...
                    switch (e) {
                      ...
                      case 'expand':
                        this._hasChilds()
                          ...
                          ? (t.field.focus(),
                            (0, I.selectContentEditable)(t.field))
                          : t.value && !this._hasChilds()
                          ? (t.value.focus(),
                            (0, I.selectContentEditable)(t.value))
                          : t.menu.focus();
                        break;
                      case 'field':
                        t.field && this.fieldEditable
                          ...
                          ? (t.value.focus(),
                            (0, I.selectContentEditable)(t.value))
                          : (this._hasChilds() ? t.expand : t.menu).focus();
                        break;
                      case 'value':
                      default:
                        t.select
              ...
              },
              {
                ...
                value: function(e, t) {
                  if (this.childs) {
                    ...
                    if (-1 !== n) {
                      n < this.visibleChilds &&
                        this.expanded &&
                        this.visibleChilds--,
                        e.hide(),
                        delete e.searchField,
                        delete e.searchValue;
                      n = this.childs.splice(n, 1)[0];
                      return (
                        (n.parent = null),
                        !1 !== t && this.updateDom({ updateIndexes: !0 }),
                        n
                      );
                    }
                  }
                  ...
                  n !== e &&
                    ...
                    ('auto' !== e && 'string' !== e) ||
                      ((this.value =
                        'string' === e
                          ? String(this.value)
                          : (0, I.parseString)(String(this.value))),
                      this.focus()),
                    this.updateDom({ updateIndexes: !0 }));
                },
              },
                ...
                value: function(e) {
                  ...
                  if ('array' === this.type) {
                    ...
                    for (t = 0; t < this.childs.length; t++)
                      if (!this.childs[t].deepEqual(e[t])) return !1;
                  } else if ('object' === this.type) {
                    ...
                    for (t = 0; t < n.length; t++) {
                      var i = this.childs[t];
                      if (i.field !== n[t] || !i.deepEqual(e[i.field]))
                        return !1;
                    }
                ...
                value: function() {
                  if (
                    ...
                    this.dom.value &&
                      'array' !== this.type &&
                      'object' !== this.type &&
                      ((this.valueInnerText = (0, I.getInnerText)(
                        this.dom.value
                      )),
                      '' === this.valueInnerText &&
                    ...
                    try {
                      ...
                      (t =
                        'string' === this.type
                          ? this._unescapeHTML(this.valueInnerText)
                          : ((e = this._unescapeHTML(this.valueInnerText)),
                            (0, I.parseString)(e))) !== this.value &&
                        ((this.value = t), this._debouncedOnChangeValue());
                    } catch (e) {
              ...
              },
              {
                ...
                value: function() {
                  this.valueError &&
                    ((this.valueError = null), this.updateError());
                },
              },
              {
                key: '_setFieldError',
              ...
              },
              {
                ...
                value: function() {
                  this.fieldError &&
                    ((this.fieldError = null), this.updateError());
                },
              },
              {
                key: '_onChangeValue',
                value: function() {
                  ...
                  var t,
                    n = this.editor.getDomSelection();
                  n.range &&
                    ((t = (0, I.textDiff)(
                      String(this.previousValue),
                      String(this.value)
                    )),
                    (n.range.startOffset = t.start),
                    (n.range.endOffset = t.end)),
                ...
                value: function() {
                  ...
                  if (e) {
                    var t = ['jsoneditor-value'],
                      n = this.value,
                      i = 'auto' === this.type ? (0, I.getType)(n) : this.type,
                      o = 'string' === i && (0, I.isUrl)(n);
                    if (
                      (t.push('jsoneditor-' + i),
                      ...
                      '' === String(this.value) &&
                        'array' !== this.type &&
                        'object' !== this.type &&
                        t.push('jsoneditor-empty'),
                      this.searchValueActive &&
                        t.push('jsoneditor-highlight-active'),
                      this.searchValue && t.push('jsoneditor-highlight'),
                      (e.className = t.join(' ')),
                      'array' === i || 'object' === i
                        ? ((t = this.childs ? this.childs.length : 0),
                          (e.title = this.type + ' containing ' + t + ' items'))
                        : o && this.editable.value
                        ? (e.title = (0, l.Iu)('openUrl'))
                        : (e.title = ''),
                      'boolean' === i && this.editable.value
                        ? (this.dom.checkbox ||
                            ((this.dom.checkbox = document.createElement(
                              'input'
                            )),
                            (this.dom.checkbox.type = 'checkbox'),
                            (this.dom.tdCheckbox = document.createElement(
                              'td'
                            )),
                      ...
                      if (!this.dom.select) {
                        ...
                        (r.value = ''),
                          (r.textContent = '--'),
                          this.dom.select.appendChild(r);
                        for (var s = 0; s < this.enum.length; s++) {
                          var a = document.createElement('option');
                          (a.value = this.enum[s]),
                            (a.textContent = this.enum[s]),
                            this.dom.select.appendChild(a);
                        }
                      ...
                      (this.dom.select.value =
                        -1 !== this.enum.indexOf(this.value) ? this.value : ''),
                        !this.schema ||
                        x(this.schema, 'oneOf') ||
                        x(this.schema, 'anyOf') ||
                        x(this.schema, 'allOf')
                    ...
                    if (
                      ...
                      (0, I.isValidColor)(n)
                        ? (this.dom.color ||
                          ...
                          (this.dom.color.style.backgroundColor = n))
                        : this._deleteDomColor(),
                      this._showTimestampTag())
                    ) {
                      this.dom.date ||
                      ...
                      if (
                        (r =
                          'function' ==
                          typeof this.editor.options.timestampFormat
                            ? this.editor.options.timestampFormat({
                                field: this.field,
                                value: this.value,
                                path: this.getPath(),
                              })
                        ...
                        this.dom.date.appendChild(document.createTextNode(r));
                      } else
                        this.dom.date.textContent = new Date(n).toISOString();
                      this.dom.date.title = new Date(n).toString();
                    } else
                      this.dom.date &&
                        (this.dom.date.parentNode.removeChild(this.dom.date),
                        delete this.dom.date);
                    (0, I.stripFormatting)(e), this._updateDomDefault();
                  }
                },
              },
              {
                ...
                value: function() {
                  ...
                  t &&
                    ...
                    ('' === String(this.field) &&
                      ...
                      'array' !== this.parent.type
                      ? (0, I.addClassName)
                      : (0, I.removeClassName))(t, 'jsoneditor-empty'),
                    ...
                    (this.searchField
                      ? (0, I.addClassName)
                      : (0, I.removeClassName))(t, 'jsoneditor-highlight'),
                    (0, I.stripFormatting)(t));
                },
              },
              {
                key: '_getDomField',
                value: function(e) {
                  if (
                    ...
                    this.dom.field &&
                      this.fieldEditable &&
                      ((this.fieldInnerText = (0, I.getInnerText)(
                        this.dom.field
                      )),
                      '' === this.fieldInnerText &&
                    ...
                    try {
                      ...
                      -1 !== n.indexOf(t)
                        ? e
                          ? (t = (0, I.findUniqueName)(t, n)) !== this.field &&
                            ((this.field = t), this._debouncedOnChangeField())
                          : this._setFieldError(
                              (0, l.Iu)('duplicateFieldError')
                            )
                        : t !== this.field &&
                          ((this.field = t), this._debouncedOnChangeField());
                    } catch (e) {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  !this.schema ||
                    ...
                    this._hasChilds() ||
                    ((e = this.dom.select || this.dom.value) &&
                      (this.value === this.schema.default
                        ? ((e.title = (0, l.Iu)('default')),
                          (0, I.addClassName)(e, 'jsoneditor-is-default'),
                          (0, I.removeClassName)(
                            e,
                            'jsoneditor-is-not-default'
                          ))
                        : (e.removeAttribute('title'),
                          (0, I.removeClassName)(e, 'jsoneditor-is-default'),
                          (0, I.addClassName)(
                            e,
                            'jsoneditor-is-not-default'
                          ))));
              ...
              },
              {
                ...
                value: function() {
                  ...
                  if ('function' != typeof e)
                    return (
                      !0 === e && (0, I.isTimestamp)(this.field, this.value)
                    );
                  e = e({
                    field: this.field,
                    value: this.value,
                  ...
                  return 'boolean' == typeof e
                    ? e
                    : (0, I.isTimestamp)(this.field, this.value);
                },
              },
              {
                key: 'clearDom',
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this._updateEditability(),
                    ...
                    'tree' === (t.tr.node = this).editor.options.mode &&
                      ((e = document.createElement('td')),
                      this.editable.field &&
                        this.parent &&
                        (((n = document.createElement('button')).type =
                          'button'),
                        ((t.drag = n).className =
              ...
              },
              {
                ...
                value: function() {
                  return (
                    (this.dom && this.dom.tr && this.dom.tr.parentNode) || !1
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function(t) {
                  this.dom.tr &&
                    ((t ? (0, I.addClassName) : (0, I.removeClassName))(
                      this.dom.tr,
                ...
                value: function(t, e) {
                  (this.selected = t),
                    this.dom.tr &&
                      ...
                      (e ? (0, I.addClassName) : (0, I.removeClassName))(
                        this.dom.tr,
                        'jsoneditor-first'
                      ),
                      this.append && this.append.setSelected(t),
                      this.showMore && this.showMore.setSelected(t),
                      this.childs &&
                        this.childs.forEach(function(e) {
                          e.setSelected(t);
                        }));
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  e &&
                    (this.fieldEditable
                      ? ((e.contentEditable = this.editable.field),
                        (e.spellcheck = !1),
                        (e.className = 'jsoneditor-field'))
                      : ((e.contentEditable = !1),
                        (e.className = 'jsoneditor-readonly')),
                    (n =
                      void 0 !== this.index
                        ? this.index
                        : void 0 !== this.field
                        ? this.field
                        : (n = this.editor.options.schema
                            ? k._findSchema(
                    ...
                    document.activeElement !== e &&
                      n !== this._unescapeHTML((0, I.getInnerText)(e)) &&
                      (e.innerHTML = n),
                    this._updateSchema());
                  ...
                  n &&
                    ('array' === this.type || 'object' === this.type
                      ? this.updateNodeName()
                      : ((i = this._escapeHTML(this.value)),
                        document.activeElement !== n &&
                          i !== this._unescapeHTML((0, I.getInnerText)(n)) &&
                          (n.innerHTML = i)));
                  var i = this.dom.tr;
                  i &&
                    ('array' === this.type || 'object' === this.type
                      ? ((0, I.addClassName)(i, 'jsoneditor-expandable'),
                        this.expanded
                          ? ((0, I.addClassName)(i, 'jsoneditor-expanded'),
                            (0, I.removeClassName)(i, 'jsoneditor-collapsed'))
                          : ((0, I.addClassName)(i, 'jsoneditor-collapsed'),
                            (0, I.removeClassName)(i, 'jsoneditor-expanded')))
                      : ((0, I.removeClassName)(i, 'jsoneditor-expandable'),
                        (0, I.removeClassName)(i, 'jsoneditor-expanded'),
                        (0, I.removeClassName)(i, 'jsoneditor-collapsed'))),
                    this._updateDomField(),
                    this._updateDomValue(),
                ...
                value: function() {
                  this.editor &&
                    ...
                    ((this.schema = this.editor.options.schema
                      ...
                      : null),
                    this.schema
                      ? (this.enum = k._findEnum(this.schema))
                      : delete this.enum);
                },
              },
              {
                ...
                value: function() {
                  ...
                  return (
                    'array' === this.type
                      ...
                      ? ((e = document.createElement('div')).textContent =
                          '{...}')
                      : (!this.editable.value && (0, I.isUrl)(this.value)
                  ...
                  return (
                    ...
                    this._hasChilds()
                      ? ((e.className = this.expanded
                          ? 'jsoneditor-button jsoneditor-expanded'
                          : 'jsoneditor-button jsoneditor-collapsed'),
                        (e.title = (0, l.Iu)('expandTitle')))
                      : ((e.className =
                          'jsoneditor-button jsoneditor-invisible'),
                        (e.title = '')),
                    e
                  );
                },
              },
              {
                ...
                value: function() {
                  ...
                  n.appendChild(i);
                  n = document.createElement('td');
                  (n.className = 'jsoneditor-tree'),
                    i.appendChild(n),
                    (e.expand = this._createDomExpandButton()),
                    n.appendChild(e.expand),
                    (e.tdExpand = n);
                  n = document.createElement('td');
                  (n.className = 'jsoneditor-tree'),
                    i.appendChild(n),
                    (e.field = this._createDomField()),
                    n.appendChild(e.field),
                    (e.tdField = n);
                  n = document.createElement('td');
                  (n.className = 'jsoneditor-tree'),
                    i.appendChild(n),
                    'object' !== this.type &&
                      ...
                      (n.className = 'jsoneditor-separator')),
                    (e.tdSeparator = n);
                  n = document.createElement('td');
                  return (
                    (n.className = 'jsoneditor-tree'),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  (i !== o.drag && i !== o.menu) ||
                    ...
                    'click' === n &&
                      i === o.menu &&
                      ((t = r.editor.highlighter).highlight(r),
                      t.lock(),
                      (0, I.addClassName)(o.menu, 'jsoneditor-selected'),
                      this.showContextMenu(o.menu, function() {
                        (0, I.removeClassName)(o.menu, 'jsoneditor-selected'),
                          t.unlock(),
                          t.unhighlight();
                      })),
                    'click' === n &&
                      i === o.expand &&
                      s &&
                      ((h = e.ctrlKey), this._onExpand(h)),
                    'click' !== n ||
                      (e.target !== r.dom.tdColor &&
                        e.target !== r.dom.color) ||
                    ...
                    'change' === n &&
                      i === o.select &&
                      ((this.dom.value.innerHTML = this._escapeHTML(
                        o.select.value
                      )),
                      this._getDomValue(),
                      this._updateDomValue());
                  ...
                  if (i === a)
                    switch (n) {
                      ...
                      case 'change':
                        ...
                        l !== this._unescapeHTML((0, I.getInnerText)(a)) &&
                          (a.innerHTML = l);
                        break;
                      case 'input':
                  ...
                  if (i === d)
                    switch (n) {
                      case 'blur':
                        ...
                        var c = this._escapeHTML(this.field);
                        c !== this._unescapeHTML((0, I.getInnerText)(d)) &&
                          (d.innerHTML = c);
                        break;
                      case 'input':
                        this._getDomField(),
                  ...
                  h &&
                    ...
                    ((void 0 !== e.offsetX
                      ...
                      : e.pageX < (0, I.getAbsoluteLeft)(o.tdSeparator)) || s
                      ? d && ((0, I.setEndOfContentEditable)(d), d.focus())
                      : a &&
                        !this.enum &&
                        ((0, I.setEndOfContentEditable)(a), a.focus())),
                    ((i !== o.tdExpand || s) &&
                      i !== o.tdField &&
                      i !== o.tdSeparator) ||
                      'click' !== n ||
                    ...
                    'function' == typeof this.editor.options.onEvent &&
                      this._onEvent(e);
                },
              },
              {
                ...
                value: function(e) {
                  var t = e.target,
                    ...
                    t =
                      ...
                      t === this.dom.select;
                  (n || t) &&
                    ((n = { field: this.getField(), path: this.getPath() }),
                    t && !this._hasChilds() && (n.value = this.getValue()),
              ...
              },
              {
                ...
                value: function(e) {
                  var t,
                    ...
                    S =
                      0 < this.editor.multiselection.nodes.length
                  ...
                  13 === y
                    ? b === this.dom.value
                      ...
                      : b === this.dom.expand &&
                        ...
                        (E = !0))
                    : 68 === y
                    ? x && w && (k.onDuplicate(S), (E = !0))
                    : 69 === y
                    ? x && (this._onExpand(C), b.focus(), (E = !0))
                    : 77 === y && w
                    ? x && (this.showContextMenu(b), (E = !0))
                    : 46 === y && w
                    ? x && (k.onRemove(S), (E = !0))
                    : 45 === y && w
                    ? x && !C
                      ? (this._onInsertBefore(), (E = !0))
                      : x && C && (this._onInsertAfter(), (E = !0))
                    : 35 === y
                    ? T &&
                      ((h = this._lastNode()) &&
                        h.focus(k.focusElement || this._getElementName(b)),
                      (E = !0))
                    : 36 === y
                    ? T &&
                      ((u = this._firstNode()) &&
                        u.focus(k.focusElement || this._getElementName(b)),
                      (E = !0))
                    : 37 === y
                    ? T && !C
                      ? ((u = this._previousElement(b)) &&
                          this.focus(this._getElementName(u)),
                        (E = !0))
                      : T &&
                        C &&
                        w &&
                        (m = N.expanded
                          ? (m = N.getAppendDom())
                            ? m.nextSibling
                            : void 0
                          : N.getDom().nextSibling) &&
                        ((p = k.getNodeFromTarget(m)),
                        (m = m.nextSibling),
                        (f = k.getNodeFromTarget(m)),
                        p &&
                          p instanceof A &&
                          1 !== N.parent.childs.length &&
                          f &&
                          f.parent &&
                          ((n = this.editor.getDomSelection()),
                          (i =
                            (o = _.parent).childs[N.getIndex() + 1] ||
                            o.append),
                          (r = _.getIndex()),
                          (s = f.getIndex()),
                          (a = o.getInternalPath()),
                          (l = f.parent.getInternalPath()),
                          S.forEach(function(e) {
                            f.parent.moveBefore(e, f);
                          }),
                          this.focus(k.focusElement || this._getElementName(b)),
                          this.editor._onAction('moveNodes', {
                            count: S.length,
                            fieldNames: S.map(j),
                            oldParentPath: o.getInternalPath(),
                            newParentPath: _.parent.getInternalPath(),
                            oldIndex: i.getIndex(),
                            newIndex: _.getIndex(),
                            oldIndexRedo: r,
                            newIndexRedo: s,
                    ...
                    ? T && !C
                      ? ((t = this._previousNode()) &&
                          ...
                          t.focus(k.focusElement || this._getElementName(b))),
                        (E = !0))
                      : !T && x && C && w
                      ? ((t = this._previousNode()) &&
                          (((c = this.editor.multiselection).start =
                            c.start || this),
                          (c.end = t),
                          (d = this.editor._findTopLevelNodes(c.start, c.end)),
                    ...
                    : 39 === y
                    ? T && !C
                      ? ((v = this._nextElement(b)) &&
                          this.focus(this._getElementName(v)),
                        (E = !0))
                      : T &&
                        C &&
                        w &&
                        (v = _.getDom().previousSibling) &&
                        (t = k.getNodeFromTarget(v)) &&
                        t.parent &&
                        !t.isVisible() &&
                        ((n = this.editor.getDomSelection()),
                        (i =
                          (o = _.parent).childs[N.getIndex() + 1] || o.append),
                        (r = _.getIndex()),
                        (s = t.getIndex()),
                        (a = o.getInternalPath()),
                        (l = t.parent.getInternalPath()),
                    ...
                    : 40 === y &&
                      (T && !C
                        ? ((p = this._nextNode()) &&
                            (this.editor.deselect(!0),
                            p.focus(k.focusElement || this._getElementName(b))),
                          (E = !0))
                        : !T && x && C && w
                        ? ((p = this._nextNode()) &&
                            (((c = this.editor.multiselection).start =
                        ...
                        : T &&
                          ...
                          ((g =
                              ...
                              (p =
                                (p = N.expanded
                                  ? N.append
                                    ? N.append._nextNode()
                                    : void 0
                                  : N._nextNode()) && !p.isVisible()
                                  ? p.parent.showMore
                                  : p) && p instanceof A
                                ? N
                                : p) &&
                            (p._nextNode() || p.parent.append)) &&
                            g.parent &&
                            ((n = this.editor.getDomSelection()),
                            (i =
                              (o = _.parent).childs[N.getIndex() + 1] ||
                            ...
                            (s = g.getIndex()),
                            (a = o.getInternalPath()),
                            (l = g.parent.getInternalPath()),
                            S.forEach(function(e) {
                              g.parent.moveBefore(e, g);
                            }),
                            this.focus(
                              k.focusElement || this._getElementName(b)
                            ),
                            this.editor._onAction('moveNodes', {
                              count: S.length,
                              fieldNames: S.map(j),
              ...
              },
              {
                ...
                value: function(e) {
                  var t, n, i;
                  e &&
                    ((i = (n = (t = this.dom.tr.parentNode).parentNode)
                      .scrollTop),
                    n.removeChild(t)),
              ...
              },
              {
                ...
                value: function() {
                  var t, e;
                  'function' == typeof this.editor.options.onColorPicker &&
                    this.dom.color &&
                    ((t = this)._deleteDomColor(),
                    t.updateDom(),
                    (e = (0, h.w)(
                      this.dom.color,
                      this.editor.getPopupAnchor()
                    )),
                    this.editor.options.onColorPicker(e, this.value, function(
                      e
                    ) {
                      'string' == typeof e &&
                        e !== t.value &&
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  t.expand(!0),
                    this.parent.insertAfter(t, this),
                    this.editor.highlighter.unhighlight(),
                    t.focus('field');
                  n = this.editor.getDomSelection();
                ...
                value: function(n, e) {
                  var t,
                    ...
                    o =
                      ...
                      arguments[2];
                  'string' == typeof n && (n = (0, I.parsePath)(n)),
                    this._hasChilds() &&
                      (this.hideChilds(),
                      (t = this.childs),
                      ...
                      'object' === this.type
                        ? this.childs.sort(function(e, t) {
                            return i * c()(e.field, t.field);
                          })
                        : this.childs.sort(function(e, t) {
                            (e = e.getNestedChild(n)),
              ...
              },
              {
                ...
                value: function(e) {
                  e.table &&
                    (e.nextTr
                      ? e.table.insertBefore(this.getDom(), e.nextTr)
                      : e.table.appendChild(this.getDom())),
              ...
              },
              {
                key: 'getNestedChild',
                value: function(e) {
                  for (var t = 0, n = this; n && t < e.length; )
                    (n = n.findChildByProperty(e[t])), t++;
                  return n;
                },
              },
              {
                ...
                value: function(t) {
                  if ('object' === this.type)
                    return this.childs.find(function(e) {
                      return e.field === t;
                    });
                },
              },
              ...
              },
              {
                ...
                value: function() {
                  return (
                    this.showMore || (this.showMore = new T(this.editor, this)),
                    this.showMore.getDom()
                  );
                },
              },
                ...
                value: function() {
                  ...
                  if (t && t.parentNode)
                    for (
                      var n = t;
                      (n = n.previousSibling),
                        (e = k.getNodeFromTarget(n)),
                        n && e && e instanceof A && !e.isVisible();
                ...
                value: function() {
                  ...
                  if (t && t.parentNode)
                    for (
                      ...
                      (n = n.previousSibling), (e = k.getNodeFromTarget(n));
                  return e;
                },
              },
              {
              ...
              },
              {
                ...
                value: function(t, n) {
                  ...
                  null != e &&
                    (e.length && t.push({ type: 'separator' }),
              ...
              },
              {
                ...
                value: function(e, t) {
                  ...
                  this.editable.value &&
                    ...
                    this.editor.options.onCreateMenu &&
                      ((i = o.getPath()),
              ...
              },
              {
                ...
                value: function() {
                  var n = this,
                    e = this.editor.options.modalAnchor || m.qD,
                    t = this.getValue();
                  (0, u.showSortModal)(
                    e,
                    t,
              ...
              },
              {
                ...
                value: function(e) {
                  return e instanceof Array
                    ...
                    ? 'object'
                    : 'string' == typeof e &&
                      'string' != typeof (0, I.parseString)(e)
                    ? 'string'
                    : 'auto';
                },
              },
        ...
        (N.prototype.DEBOUNCE_INTERVAL = 150),
          (N.prototype.MAX_SEARCH_RESULTS = 999);
        var y = 100;
        function b(e) {
        ...
        (N.focusElement = void 0),
          (N.select = function(e) {
            setTimeout(function() {
              (0, I.selectContentEditable)(e);
            }, 0);
          }),
          (N.onDragStart = function(t, e) {
            if (!Array.isArray(t)) return N.onDragStart([t], e);
            var n, i, o, r, s;
            0 !== t.length &&
              ((n = t[0]),
              (i = t[t.length - 1]),
              (o = n.parent),
              (s = N.getNodeFromTarget(e.target)),
              (r = n.editor),
              (s =
                (0, I.getAbsoluteTop)(s.dom.tr) -
                (0, I.getAbsoluteTop)(n.dom.tr)),
              r.mousemove ||
                (r.mousemove = (0, I.addEventListener)(
                  e.view,
                  'mousemove',
                  function(e) {
                    N.onDrag(t, e);
              ...
              r.mouseup ||
                (r.mouseup = (0, I.addEventListener)(
                  e.view,
                  'mouseup',
                  function(e) {
                    N.onDragEnd(t, e);
          ...
          (N.onDrag = function(e, t) {
            ...
            if (0 !== e.length) {
              var n,
                ...
                h = e[0],
                u = h.dom.tr,
                p = (0, I.getAbsoluteTop)(u),
                m = u.offsetHeight;
              if (l < p) {
                for (
                  b = u;
                  (b = b.previousSibling),
                    (x = N.getNodeFromTarget(b)),
                    (o = b ? (0, I.getAbsoluteTop)(b) : 0),
                    b && l < o;

                );
                (x = x && !x.parent ? void 0 : x) ||
                  ((b = (f = u.parentNode.firstChild) ? f.nextSibling : void 0),
                  (x = N.getNodeFromTarget(b)) === h && (x = void 0)),
                  !(x =
                    x &&
                    x.isVisible() &&
                    (o = (b = x.dom.tr) ? (0, I.getAbsoluteTop)(b) : 0) + m < l
                      ? void 0
                      : x) ||
                    (!1 !== a.options.limitDragging &&
                      x.parent !== e[0].parent) ||
                    (e.forEach(function(e) {
                      x.parent.moveBefore(e, x);
                    }),
                    (c = !0));
              } else {
                var f,
                ...
                if (
                  (m = (f =
                    v.expanded && v.append ? v.append.getDom() : v.dom.tr)
                    ? f.nextSibling
                    : void 0)
                ) {
                  for (
                    r = (0, I.getAbsoluteTop)(m), n = m;
                    (i = N.getNodeFromTarget(n)),
                      n &&
                        ((s = n.nextSibling
                          ? (0, I.getAbsoluteTop)(n.nextSibling)
                          : 0),
                        (s = n ? s - r : 0),
                        i &&
                          i.parent.childs.length === e.length &&
                          i.parent.childs[e.length - 1] === v &&
                          (p += 27),
                        (n = n.nextSibling)),
                      n && p + s < l;
                  ...
                  if (i && i.parent) {
                    for (
                      var m = d - a.drag.mouseX,
                        m = Math.round(m / 24 / 2),
                        g = a.drag.level + m,
                        y = i.getLevel(),
                        b = i.dom.tr && i.dom.tr.previousSibling;
                      y < g && b;

                    ) {
                      var x = N.getNodeFromTarget(b),
                        C = e.some(function(e) {
                          return e === x || x.isDescendantOf(e);
                        });
                      if (!C) {
                        if (!(x instanceof A)) break;
                        C = x.parent.childs;
                        if (C.length === e.length && C[e.length - 1] === v)
                          break;
                        y = (i = N.getNodeFromTarget(b)).getLevel();
                      }
                      b = b.previousSibling;
                    }
                    (i =
                      i instanceof A &&
                      !i.isVisible() &&
                      i.parent.showMore.isVisible()
                        ? i._nextNode()
                        : i) &&
                      (!1 === a.options.limitDragging ||
                        i.parent === e[0].parent) &&
                      i.dom.tr &&
                      i.dom.tr !== f.nextSibling &&
                      (e.forEach(function(e) {
              ...
              c && ((a.drag.mouseX = d), (a.drag.level = h.getLevel())),
                a.startAutoScroll(l),
                t.preventDefault();
            }
          }),
          (N.onDragEnd = function(e, t) {
            if (!Array.isArray(e)) return N.onDrag([e], t);
            var n, i, o, r, s, a, l, d, c;
            0 !== e.length &&
              ((c = e[0]),
              (n = c.editor),
              c && c.dom.menu && c.dom.menu.focus(),
              (i = n.drag.oldParent.getInternalPath()),
              (o = c.parent.getInternalPath()),
              (r = n.drag.oldParent === c.parent),
              (s = n.drag.oldNextNode.getIndex()),
              (a = c.getIndex()),
              (l = n.drag.oldParentPathRedo),
              (d = n.drag.oldIndexRedo),
              (c = r && d < a ? a + e.length : a),
              (r && d === a) ||
                n._onAction('moveNodes', {
                  count: e.length,
                  fieldNames: e.map(j),
                  oldParentPath: i,
                  newParentPath: o,
              ...
              (document.body.style.cursor = n.drag.oldCursor),
              n.highlighter.unlock(),
              e.forEach(function(e) {
                e.updateDom(),
                  t.target !== e.dom.drag &&
                    t.target !== e.dom.menu &&
                    n.highlighter.unhighlight();
              }),
              delete n.drag,
              n.mousemove &&
                ((0, I.removeEventListener)(t.view, 'mousemove', n.mousemove),
                delete n.mousemove),
              n.mouseup &&
                ((0, I.removeEventListener)(t.view, 'mouseup', n.mouseup),
                delete n.mouseup),
              n.stopAutoScroll(),
              t.preventDefault());
          }),
          ...
          (N._findSchema = function(e, t, n) {
            for (
              var i =
                  3 < arguments.length && void 0 !== arguments[3]
                    ? arguments[3]
                    : e,
                o = n.slice(1, n.length),
                r = n[0],
                s = [i],
                a = 0,
                l = [i.oneOf, i.anyOf, i.allOf];
              a < l.length;
              a++
            ) {
              var d = l[a];
              Array.isArray(d) && (s = s.concat(d));
            }
            var c,
              h = S(s);
            try {
              for (h.s(); !(c = h.n()).done; ) {
                if ('$ref' in (i = c.value) && 'string' == typeof i.$ref) {
                  var u,
                    p = i.$ref;
                  if (p in t) i = t[p];
                  else {
                    if (!p.startsWith('#/')) {
                      if (
                        1 !==
                        (null === (u = p.match(/#\//g)) || void 0 === u
                          ? void 0
                          : u.length)
                      )
                        throw Error('Unable to resolve reference '.concat(p));
                      var m = w(p.split('#/'), 2),
                        f = m[0],
                        v = m[1];
                      if (f in t) {
                        var g = t[f],
                          y = { $ref: '#/'.concat(v) };
                        return N._findSchema(g, t, o, y);
                      }
                      throw Error('Unable to resolve reference '.concat(p));
                    }
                    var b,
                      x = p.substring(2).split('/'),
                      i = e,
                      C = S(x);
                    try {
                      for (C.s(); !(b = C.n()).done; ) {
                        var T = b.value;
                        if (!(T in i))
                          throw Error('Unable to resovle reference '.concat(p));
                        i = i[T];
                      }
                    } catch (e) {
                      C.e(e);
                ...
                if ('string' != typeof r) {
                  if (
                    ...
                    return (i = i.items), N._findSchema(e, t, o, i);
                } else {
                  if (
                    'object' === _(i.properties) &&
                    null !== i.properties &&
                    r in i.properties
                  )
                    return (i = i.properties[r]), N._findSchema(e, t, o, i);
                  if (
                    'object' === _(i.patternProperties) &&
                    null !== i.patternProperties
                  )
                    for (var E in i.patternProperties)
                      if (r.match(E))
                        return (
                          (i = i.patternProperties[E]),
                          N._findSchema(e, t, o, i)
                        );
                  if ('object' === _(i.additionalProperties))
                    return (
                      (i = i.additionalProperties), N._findSchema(e, t, o, i)
                    );
                }
              }
            } catch (e) {
          ...
          (N.onDuplicate = function(e) {
            ...
            e &&
              ...
              ((t = e[e.length - 1]),
              (i = t.parent),
              (n = t.editor).deselect(n.multiselection.nodes),
              (o = n.getDomSelection()),
              (r = t),
              (s = e.map(function(e) {
                var t,
                  n = e.clone();
                return (
                  'object' === e.parent.type &&
                    ((t = e.parent.getFieldNames()),
                    (n.field = (0, I.findUniqueName)(e.field, t))),
                  i.insertAfter(n, r),
                  (r = n)
                );
              })),
              1 === e.length
                ? 'object' === s[0].parent.type
                  ? ((s[0].dom.field.innerHTML = e[0]._escapeHTML(e[0].field)),
                    s[0].focus('field'))
                  : s[0].focus()
                : n.select(s),
              (a = n.getDomSelection()),
              n._onAction('duplicateNodes', {
                paths: e.map(b),
                clonePaths: s.map(b),
          ...
          (N.targetIsColorPicker = function(e) {
            var t = N.getNodeFromTarget(e);
            if (t)
        ...
        var A =
          (((C.prototype = new N()).getDom = function() {
            var e = this.dom;
            if (e.tr) return e.tr;
            this._updateEditability();
            var t = document.createElement('tr');
            (t.className = 'jsoneditor-append'),
              (t.node = this),
              (e.tr = t),
              'tree' === this.editor.options.mode &&
            ...
            return (
              i.appendChild(
                document.createTextNode('(' + (0, l.Iu)('empty') + ')')
              ),
          ...
          (C.prototype.updateDom = function(e) {
            var t = this.dom,
              n = t.td;
          ...
          (C.prototype.showContextMenu = function(e, t) {
            var n = this,
              i = [
                {
                  text: (0, l.Iu)('auto'),
            ...
            this.editor.options.onCreateMenu &&
              ((i = n.parent.getPath()),
              (o = this.editor.options.onCreateMenu(o, {
                type: 'append',
                path: i,
                paths: [i],
              }))),
          ...
          (C.prototype.onEvent = function(e) {
            ...
            i === o.menu &&
              ('mouseover' === n
                ...
                : 'mouseout' === n && this.editor.highlighter.unhighlight()),
              'click' === n &&
                i === o.menu &&
                ((t = this.editor.highlighter).highlight(this.parent),
                t.lock(),
                (0, I.addClassName)(o.menu, 'jsoneditor-selected'),
                this.showContextMenu(o.menu, function() {
                  (0, I.removeClassName)(o.menu, 'jsoneditor-selected'),
        ...
        var T =
          (((k.prototype = new N()).getDom = function() {
            return (
              this.dom.tr ||
              (this._updateEditability(),
              this.dom.tr ||
                ...
                (o = document.createElement('a')).appendChild(
                  document.createTextNode((0, l.Iu)('showMore'))
                ),
                (o.href = '#'),
                (o.onclick = function(e) {
                  return (
                    (n.visibleChilds =
                      Math.floor(
                        n.visibleChilds / n.getMaxVisibleChilds() + 1
                      ) * n.getMaxVisibleChilds()),
                    t.updateDom(),
                    n.showChilds(),
                    e.preventDefault(),
                    !1
                ...
                (r = document.createElement('a')).appendChild(
                  document.createTextNode((0, l.Iu)('showAll'))
                ),
                (r.href = '#'),
                (r.onclick = function(e) {
                  return (
                ...
                (e = document.createElement('div')),
                (i = document.createTextNode(this._getShowMoreText())),
                (e.className = 'jsoneditor-show-more'),
                e.appendChild(i),
                e.appendChild(o),
                e.appendChild(document.createTextNode('. ')),
                e.appendChild(r),
                e.appendChild(document.createTextNode('. ')),
                (o = document.createElement('td')).appendChild(e),
          ...
          (k.prototype.updateDom = function(e) {
            var t;
            this.isVisible()
              ? ((this.dom.tr.node = this.parent.childs[
                  this.parent.visibleChilds
                ]),
                this.dom.tr.parentNode ||
                  ((t = this.parent._getNextTr()) &&
                    t.parentNode.insertBefore(this.dom.tr, t)),
          ...
          (k.prototype._getShowMoreText = function() {
            return (
              (0, l.Iu)('showMoreStatus', {
          ...
          (k.prototype.onEvent = function(e) {
              ...
              (this.actions = {
                ...
                moveNodes: {
                  undo: function(n) {
                    ...
                    e.childs
                      .slice(n.newIndex, n.newIndex + n.count)
                      .forEach(function(e, t) {
                        (e.field = n.fieldNames[t]), i.moveBefore(e, o);
                      }),
                      null === n.newParentPathRedo &&
                        (n.newParentPathRedo = e.getInternalPath());
                  },
                  redo: function(n) {
                    ...
                    e.childs
                      .slice(n.oldIndexRedo, n.oldIndexRedo + n.count)
                      .forEach(function(e, t) {
                        (e.field = n.fieldNames[t]), i.moveBefore(e, o);
                      });
                  },
                  ...
                  if (this.canUndo()) {
                    ...
                    if (e) {
                      ...
                      if (t && t.undo) {
                        ...
                        console.error(
                          new Error('unknown action "' + e.action + '"')
                        );
                    }
        ...
        var F = (function() {
          function o(e, t) {
            ...
            e = document.createElement('div');
            ((this.dom.wrapper = e).className = 'jsoneditor-search'),
              t.appendChild(e);
            t = document.createElement('div');
            ((this.dom.results = t).className = 'jsoneditor-results'),
              e.appendChild(t);
            t = document.createElement('div');
            ((this.dom.input = t).className = 'jsoneditor-frame'),
              (t.title = (0, l.Iu)('searchTitle')),
              e.appendChild(t);
            e = document.createElement('button');
            (e.type = 'button'),
              (e.className = 'jsoneditor-refresh'),
              t.appendChild(e);
            var i = document.createElement('input');
            (i.type = 'text'),
              ((this.dom.search = i).oninput = function(e) {
            ...
            e = document.createElement('button');
            (e.type = 'button'),
              (e.title = (0, l.Iu)('searchNextResultTitle')),
              (e.className = 'jsoneditor-next'),
              (e.onclick = function() {
                n.next();
              }),
              t.appendChild(e);
            e = document.createElement('button');
            (e.type = 'button'),
              (e.title = (0, l.Iu)('searchPreviousResultTitle')),
              (e.className = 'jsoneditor-previous'),
              (e.onclick = function() {
                n.previous();
              }),
              t.appendChild(e);
            ...
            (t = [
              {
                ...
                value: function(e) {
                  ...
                  this.results &&
                    ((t =
                      null !== this.resultIndex ? this.resultIndex + 1 : 0) >
                      this.results.length - 1 && (t = 0),
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  this.results &&
                    ...
                    this._setActiveResult((n = n < 0 ? t : n), e));
                },
              },
              {
                ...
                value: function(e, t) {
                  ...
                  var i = this.results[this.resultIndex].node,
                    o = this.results[this.resultIndex].elem;
                  'field' === o
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (t !== this.lastText || e) {
                    ...
                    this._setActiveResult(n, !1),
                      void 0 !== t
                        ? ((t = this.results.length),
                    ...
                    (this.path.textContent = ''),
                      o &&
                        ...
                        o.forEach(function(n, i) {
                          ...
                          (t.className = 'jsoneditor-treepath-element'),
                            (t.innerText = n.name),
                            (t.onclick = function(e) {
                              this.selectionCallback &&
                                this.selectionCallback(e);
                            }.bind(r, n)),
                            r.path.appendChild(t),
                            n.children.length &&
                              ...
                              (e.onclick = function() {
                                ...
                                n.children.forEach(function(e) {
                                  t.push({
                                    ...
                                    className:
                                      'jsoneditor-type-modes' +
                                      (o[i + 1] + 1 && o[i + 1].name === e.name
                                        ? ' jsoneditor-selected'
                                        : ''),
                                    click: function(e, t) {
                                      this.contextMenuCallback &&
                                        this.contextMenuCallback(e, t);
                                    }.bind(r, n, e.name),
                                  });
                                }),
                                  new s.x(t, { limitHeight: !0 }).show(
                                    e,
                                    r.root,
                                    !0
                                  );
                              }),
                              r.path.appendChild(e)),
                            i === o.length - 1 &&
                              ((t = (e || t).getBoundingClientRect().right),
                              r.path.offsetWidth < t && (r.path.scrollLeft = t),
                              r.path.scrollLeft &&
                                (((t = document.createElement(
                                  'span'
                                )).className =
                                  'jsoneditor-treepath-show-all-btn'),
                                (t.title = 'show all path'),
                                (t.textContent = '...'),
                                (t.onclick = function(e) {
                                  ((r.contentMenuClicked = !1), I.addClassName)(
                                    r.path,
                                    'show-all'
                                  ),
                                    (r.path.style.width =
                                      r.path.parentNode.getBoundingClientRect()
                                        .width -
                                      10 +
                                      'px'),
                                    (r.path.onblur = function() {
                                      if (r.contentMenuClicked)
                                        return (
                                          (r.contentMenuClicked = !1),
                                          void r.path.focus()
                                        );
                                      (0, I.removeClassName)(
                                        r.path,
                                        ...
                                        (r.path.onblur = void 0),
                                        (r.path.style.width = ''),
                                        r.setPath(e);
                                    });
                                }.bind(r, o)),
                                r.path.insertBefore(t, r.path.firstChild)));
                        });
                  },
                },
                {
        ...
        (t.create = function(e, t) {
          ...
          (this.container = e),
            ...
            t.autocomplete &&
              (this.autocomplete = (function(s) {
                ((s = s || {}).filter = s.filter || 'start'),
                  (s.trigger = s.trigger || 'keydown'),
                  (s.confirmKeys = s.confirmKeys || [39, 35, 9]),
                  (s.caseSensitive = s.caseSensitive || !1);
                var o = '',
                  r = '',
                ...
                function c(e) {
                  ...
                  document.createRange
                    ? ((t = document.createRange()).selectNodeContents(e),
                      ...
                      n.addRange(t))
                    : document.selection &&
                      ((t = document.body.createTextRange()).moveToElementText(
                        e
                      ),
                      t.collapse(!1),
                      t.select());
                ...
                function h(e) {
                  return (
                    void 0 === t &&
                      (((t = document.createElement('span')).style.visibility =
                        'hidden'),
                  ...
                  v = {
                    ...
                    show: function(e, t, n) {
                      ...
                      (this.startFrom = t),
                        ...
                        this.element.addEventListener &&
                          (this.element.removeEventListener('keydown', C),
                          this.element.addEventListener('keydown', C, !1),
                          this.element.removeEventListener('blur', T),
                          this.element.addEventListener('blur', T, !1)),
                        a.appendChild(this.elementHint),
                        a.appendChild(d),
                    ...
                    repaint: function(e) {
                      ...
                      for (var i = 0; i < t; i++) {
                        ...
                        if (
                          (!s.caseSensitive &&
                            0 === o.toLowerCase().indexOf(n.toLowerCase())) ||
                          (s.caseSensitive && 0 === o.indexOf(n))
                        ) {
                          (this.elementHint.innerText =
                            l + n + o.substring(n.length)),
                            (this.elementHint.realInnerText = l + o);
                          break;
                        }
                      }
                      (d.style.left = h(l) + 'px'),
                        g.refresh(n, this.options),
                        (this.elementHint.style.width =
                          h(this.elementHint.innerText) + 10 + 'px'),
                        'hidden' === d.style.visibility ||
                          (this.elementHint.style.width =
                            h(this.elementHint.innerText) +
                            d.clientWidth +
                            'px');
                    },
                  },
                    ...
                    (f = {
                      ...
                      refresh: function(i, e) {
                        ...
                        var t =
                          ...
                          n = u.parentNode.getBoundingClientRect(),
                          o = n.top - 6,
                          n = t - n.bottom - 6;
                        p = [];
                        var r =
                          ...
                          e = r
                            ? e.filter(function(e) {
                                return r(
                                  s.caseSensitive ? i : i.toLowerCase(),
                                  s.caseSensitive ? e : e.toLowerCase(),
                                  s
                                );
                              })
                            : [];
                        0 !==
                          (p = e.map(function(e) {
                            ...
                            return (
                              n.appendChild(
                                document.createTextNode(e.substring(i.length))
                              ),
                              t.appendChild(n),
                              u.appendChild(t),
                              t
                          ...
                          ((1 === p.length &&
                            ((i.toLowerCase() === p[0].__hint.toLowerCase() &&
                              !s.caseSensitive) ||
                              (i === p[0].__hint && s.caseSensitive))) ||
                            p.length < 2 ||
                            (f.highlight(0),
                            3 * n < o
                              ? ((u.style.maxHeight = o + 'px'),
                                (u.style.top = ''),
                                (u.style.bottom = '100%'))
                              : ((u.style.top = '100%'),
                                (u.style.bottom = ''),
                                (u.style.maxHeight = n + 'px')),
                            (u.style.visibility = 'visible')));
                      },
                      highlight: function(e) {
                        -1 !== n && p[n] && (p[n].className = 'item'),
                          (p[e].className = 'item hover'),
                          (n = e);
                      },
                      move: function(e) {
                        return 'hidden' === u.style.visibility
                          ? ''
                          : (m + e === -1 ||
                              m + e === p.length ||
                              ((m += e), f.highlight(m)),
                ...
                var C = function(e) {
                    ...
                    if (null != this.elementHint && 33 !== t && 34 !== t) {
                      ...
                      var n = (n = this.element.innerText).replace('\n', '');
                      ...
                      if (13 !== t) {
                        if (40 === t) {
                          var i = n.substring(this.startFrom),
                            o = g.move(1);
                          return (
                            '' === o && v.onArrowDown(),
                            (this.elementHint.innerText =
                              l + i + o.substring(i.length)),
                            (this.elementHint.realInnerText = l + o),
                            e.preventDefault(),
                            void e.stopPropagation()
                          );
                        ...
                        38 === t &&
                          ((n = n.substring(this.startFrom)),
                          '' === (r = g.move(-1)) && v.onArrowUp(),
                          (this.elementHint.innerText =
                            l + n + r.substring(n.length)),
                          (this.elementHint.realInnerText = l + r),
                          e.preventDefault(),
                          e.stopPropagation());
                      } else if (0 === this.elementHint.innerText.length)
                        v.onEnter();
                      else {
                        var r = 'hidden' === d.style.visibility;
                        if ((g.hide(), r))
                          return (
                            v.hideDropDown(),
                            v.element.focus(),
                ...
                return (
                  (g.onmouseselection = function(e, t) {
                    (t.element.innerText = t.elementHint.innerText = l + e),
                      t.hideDropDown(),
                      window.setTimeout(function() {
                        t.element.focus(), c(t.element);
                      }, 1);
                  }),
                  v
                );
          ...
          (t._setOptions = function(t) {
            ...
            (this.options = {
              ...
              onColorPicker: function(e, t, n) {
                ...
                L()
                  ? ((i = e.getBoundingClientRect().top),
                    (i = (0, I.getWindow)(e).innerHeight - i < 300 && 300 < i),
                    new (L())({
                      parent: e,
                      color: t,
                      popup: i ? 'top' : 'bottom',
              ...
              t &&
                ...
                null == t.limitDragging &&
                  null != t.schema &&
                  (this.options.limitDragging = !0)),
              this.setSchema(this.options.schema, this.options.schemaRefs),
              (this._debouncedValidate = (0, I.debounce)(
                this._validateAndCatch.bind(this),
                this.DEBOUNCE_INTERVAL
              )),
              t.onSelectionChange &&
                this.onSelectionChange(t.onSelectionChange),
              (0, l.cC)(this.options.languages),
              (0, l.m0)(this.options.language);
          }),
          (t.set = function(e) {
            e instanceof Function || void 0 === e
              ? this.clear()
              : (this.content.removeChild(this.table),
                (e = { field: this.options.name, value: e }),
                (e = new N(this, e)),
                this._setRoot(e),
          ...
          (t.update = function(e) {
            ...
            this.node.deepEqual(e) ||
              ...
              t && t.start && t.end
                ? ((n = this.node.findNodeByPath(t.start.path)),
                  (e = this.node.findNodeByPath(t.end.path)),
                  n && e
                    ? this.setSelection(t.start, t.end)
                    : this.setSelection({}, {}))
                : this.setSelection({}, {}));
          }),
          (t.get = function() {
          ...
          (t.setText = function(t) {
            try {
              this.set((0, I.parse)(t));
            } catch (e) {
              t = (0, I.tryJsonRepair)(t);
              this.set((0, I.parse)(t));
            }
          }),
          (t.updateText = function(t) {
            try {
              this.update((0, I.parse)(t));
            } catch (e) {
              t = (0, I.tryJsonRepair)(t);
              this.update((0, I.parse)(t));
            }
          ...
          (t.focus = function() {
            var e = this.scrollableContent.querySelector(
            ...
            e
              ...
              : (e = this.frame.querySelector('button')) && e.focus();
          }),
          (t.clear = function() {
                ...
                this.treePath &&
                  ((e =
                    this.node && this.selection
                      ...
                      : void 0)
                    ? this._updateTreePath(e.getNodePath())
                    : this.treePath.reset()),
                this.options.onChange)
              )
                try {
            ...
            if (n) {
              ...
              this.validateSchema &&
                (this.validateSchema(e) ||
                  (i = this.validateSchema.errors
                    .map(function(e) {
                      return (0, I.improveSchemaError)(e);
                    })
                    .map(function(e) {
                      return {
              ...
              try {
                ...
                return this._validateCustom(e).then(function(e) {
                  return (
                    r === o.validationSequence &&
                      ((e = [].concat(i, e || [])),
                      o._renderValidationErrors(e),
                      'function' == typeof t.options.onValidationError &&
                        (0, I.isValidationErrorChanged)(
                          e,
                          t.lastSchemaErrors
                        ) &&
                        t.options.onValidationError.call(t, e),
                      (t.lastSchemaErrors = e)),
                    t.lastSchemaErrors
                  );
                });
              } catch (e) {
              ...
              .map(function(e) {
                return {
                  ...
                  error: {
                    message:
                      'object' === e[0].type
                        ? (0, l.Iu)('containsInvalidProperties')
                        : (0, l.Iu)('containsInvalidItems'),
                  },
                };
              })
              .concat(e)
          ...
          (t._validateCustom = function(e) {
            try {
              if (this.options.onValidate) {
                var n = this.node,
                  t = this.options.onValidate(e);
                return ((0, I.isPromise)(t) ? t : Promise.resolve(t)).then(
                  function(e) {
                    return Array.isArray(e)
                      ? e
                          .filter(function(e) {
                          ...
                          .map(function(e) {
                            ...
                            return (
                              ...
                              { node: t, error: e, type: 'customValidation' }
                            );
                          })
                          .filter(function(e) {
          ...
          (t.startAutoScroll = function(e) {
            var t = this,
              ...
              i = (0, I.getAbsoluteTop)(n),
              o = n.clientHeight,
              r = i + o;
            e < i + 24 && 0 < n.scrollTop
              ? (this.autoScrollStep = (i + 24 - e) / 3)
              : r - 24 < e && o + n.scrollTop < n.scrollHeight
              ? (this.autoScrollStep = (r - 24 - e) / 3)
          ...
          (t.setDomSelection = function(e) {
            ...
            e &&
              ('scrollTop' in e &&
                ...
                (this.scrollableContent.scrollTop = e.scrollTop),
              e.paths
                ? ((t = this),
                  (i = e.paths.map(function(e) {
                    return t.node.findNodeByInternalPath(e);
                  })),
                  this.select(i))
                : ((i =
                    (n = e.path
                      ? this.node.findNodeByInternalPath(e.path)
                      : null) && e.domName
                      ? n.dom[e.domName]
                      : null),
                  e.range && i
                    ? ((i = Object.assign({}, e.range, { container: i })),
                      (0, I.setSelectionOffset)(i))
                    : n && n.focus()));
          }),
          (t.getDomSelection = function() {
            var t = N.getNodeFromTarget(this.focusTarget),
              n = this.focusTarget,
              e = t
                ? Object.keys(t.dom).find(function(e) {
                    return t.dom[e] === n;
                  })
                : null,
              i = (0, I.getSelectionOffset)();
            return (
              (i =
                (i = i && 'DIV' !== i.container.nodeName ? null : i) &&
                i.container !== n
                  ? null
                  : i) && delete i.container,
              {
                ...
                range: i,
                paths:
                  0 < this.multiselection.length
                    ? this.multiselection.nodes.map(function(e) {
                        return e.getInternalPath();
                      })
                    : null,
              ...
              ? ((i = this).animateTimeout &&
                ...
                (function e() {
                  ...
                  3 < Math.abs(t)
                    ? ((s.scrollTop += t / 3),
                      (i.animateCallback = n),
                      (i.animateTimeout = setTimeout(e, 50)))
                    : (n && n(!0),
                      (s.scrollTop = r),
          ...
          (t._createFrame = function() {
            ...
            (this.frameFocusTracker = new a.R(s)),
              (this.frame.onclick = function(e) {
                var t = e.target;
                n(e), 'BUTTON' === t.nodeName && e.preventDefault();
              }),
              (this.frame.oninput = n),
              (this.frame.onchange = n),
              (this.frame.onkeydown = n),
              (this.frame.onkeyup = n),
              (this.frame.oncut = n),
              (this.frame.onpaste = n),
              (this.frame.onmousedown = n),
              (this.frame.onmouseup = n),
              (this.frame.onmouseover = n),
              (this.frame.onmouseout = n),
              (0, I.addEventListener)(this.frame, 'focus', n, !0),
              (0, I.addEventListener)(this.frame, 'blur', n, !0),
              (this.frame.onfocusin = n),
              (this.frame.onfocusout = n),
              this.options.mainMenuBar &&
                ((0, I.addClassName)(this.contentOuter, 'has-main-menu-bar'),
                (this.menu = document.createElement('div')),
                (this.menu.className = 'jsoneditor-menu'),
                this.frame.appendChild(this.menu),
                ((s = document.createElement('button')).type = 'button'),
                (s.className = 'jsoneditor-expand-all'),
                (s.title = (0, l.Iu)('expandAll')),
                (s.onclick = function() {
                  t.expandAll();
                }),
                this.menu.appendChild(s),
                ((s = document.createElement('button')).type = 'button'),
                (s.title = (0, l.Iu)('collapseAll')),
                (s.className = 'jsoneditor-collapse-all'),
                (s.onclick = function() {
                  t.collapseAll();
                }),
                this.menu.appendChild(s),
                ...
                this.options.enableTransform &&
                  (((e = document.createElement('button')).type = 'button'),
                  (e.title = (0, l.Iu)('transformTitleShort')),
                  (e.className = 'jsoneditor-transform'),
                  (e.onclick = function() {
                ...
                this.history &&
                  ...
                  (this.history.onChange = function() {
                    (i.disabled = !t.history.canUndo()),
                      (o.disabled = !t.history.canRedo());
                  }),
                  this.history.onChange()),
                this.options &&
                  this.options.modes &&
                  this.options.modes.length &&
                  ((r = this).modeSwitcher = new d.x(
                    this.menu,
                    this.options.modes,
                    this.options.mode,
                    function(e) {
                ...
                this.options.search &&
                  (this.searchBox = new F(this, this.menu))),
              this.options.navigationBar &&
                ...
                (this.treePath = new V(this.navBar, this.getPopupAnchor())),
          ...
          (t._onEvent = function(e) {
            if (!N.targetIsColorPicker(e.target)) {
              var t,
                n = N.getNodeFromTarget(e.target);
              if (
                ...
                if ('click' === e.type) {
                  if (e.target === n.dom.menu)
                    return void this.showContextMenu(e.target);
                  e.hasMoved || this.deselect();
                }
                'mousedown' === e.type &&
                  N.onDragStart(this.multiselection.nodes, e);
              } else
                'mousedown' === e.type &&
                  (0, I.hasParentNode)(e.target, this.content) &&
                  (this.deselect(),
                  n && e.target === n.dom.drag
                    ? N.onDragStart(n, e)
                    : (n &&
                        (e.target === n.dom.field ||
                          e.target === n.dom.value ||
                          e.target === n.dom.select)) ||
          ...
          (t._updateTreePath = function(e) {
            ...
            e && e.length
              ? ((0, I.removeClassName)(this.navBar, 'nav-bar-empty'),
                (n = []),
                e.forEach(function(e) {
                  var t = { name: i(e), node: e, children: [] };
                  e.childs &&
                    e.childs.length &&
                    e.childs.forEach(function(e) {
                      t.children.push({ name: i(e), node: e });
                    }),
                    n.push(t);
                }),
                this.treePath.setPath(n))
              : (0, I.addClassName)(this.navBar, 'nav-bar-empty');
          }),
          ...
          (t._onTreePathMenuItemSelected = function(e, t) {
            e &&
              e.children.length &&
              (e = e.children.find(function(e) {
                return e.name === t;
              })) &&
              e.node &&
              (this._updateTreePath(e.node.getNodePath()),
              e.node.expandTo(),
              e.node.focus());
          }),
          ...
          (t._updateDragDistance = function(e) {
            ...
            return (
              (this.dragDistanceEvent.dragDistance = Math.sqrt(t * t + n * n)),
              (this.dragDistanceEvent.hasMoved =
                this.dragDistanceEvent.hasMoved ||
                10 < this.dragDistanceEvent.dragDistance),
          ...
          (t._onMultiSelectStart = function(e) {
            ...
            'tree' === this.options.mode &&
              ...
              (t = this).mousemove ||
                (this.mousemove = (0, I.addEventListener)(
                  e.view,
                  'mousemove',
                  function(e) {
                    t._onMultiSelect(e);
              ...
              this.mouseup ||
                (this.mouseup = (0, I.addEventListener)(
                  e.view,
                  'mouseup',
                  function(e) {
          ...
          (t._onMultiSelect = function(e) {
            ...
            e.preventDefault(),
              this._updateDragDistance(e),
              e.hasMoved &&
                ((t = N.getNodeFromTarget(e.target)) &&
                  (null == this.multiselection.start &&
                    (this.multiselection.start = t),
                  (this.multiselection.end = t)),
                this.deselect(),
                (e = this.multiselection.start),
                (t = this.multiselection.end || this.multiselection.start),
                e &&
                  t &&
                  ((this.multiselection.nodes = this._findTopLevelNodes(e, t)),
                  this.multiselection.nodes &&
                    this.multiselection.nodes.length &&
                    ((t = this.multiselection.nodes[0]),
                    this.multiselection.start === t ||
                    this.multiselection.start.isDescendantOf(t)
          ...
          (t._onMultiSelectEnd = function(e) {
            ...
            t && t.dom.menu && t.dom.menu.focus(),
              (this.multiselection.start = null),
              (this.multiselection.end = null),
              this.mousemove &&
                ((0, I.removeEventListener)(
                  e.view,
                  'mousemove',
                  this.mousemove
                ),
              ...
              this.mouseup &&
                ((0, I.removeEventListener)(e.view, 'mouseup', this.mouseup),
                delete this.mouseup);
          }),
          ...
          (t.select = function(e) {
            ...
            e &&
              ...
              this._selectionChangedHandler &&
                ((e = this.getSelection()),
                this._selectionChangedHandler(e.start, e.end)));
          }),
          (t._findTopLevelNodes = function(e, t) {
            for (
              var n = e.getNodePath(), i = t.getNodePath(), o = 0;
              o < n.length && n[o] === i[o];
            ...
            if (
              ((s && e) ||
                (r.parent
                  ? (r = (e = s = r).parent)
                  : ((s = r.childs[0]), (e = r.childs[r.childs.length - 1]))),
              r && s && e)
            ) {
              (t = r.childs.indexOf(s)),
                (s = r.childs.indexOf(e)),
                (e = Math.min(t, s)),
                (s = Math.max(t, s));
              return r.childs.slice(e, s + 1);
            }
            return [];
          }),
          (t._showAutoComplete = function(t) {
            var n,
              i = N.getNodeFromTarget(t),
              o = '';
            0 <= t.className.indexOf('jsoneditor-value') && (o = 'value'),
              '' !==
                (o =
                  0 <= t.className.indexOf('jsoneditor-field') ? 'field' : o) &&
                ((n = this),
                setTimeout(function() {
                  var e;
                  !i ||
                  !(
                    'focus' === n.options.autocomplete.trigger ||
                    0 < t.innerText.length
                  ) ||
                  null ===
                    (e = n.options.autocomplete.getOptions(
                      t.innerText,
                      i.getPath(),
                      o,
                      i.editor
                    ))
                    ? n.autocomplete.hideDropDown()
                    ...
                    ? e
                        .then(function(e) {
                          null === e
                            ? n.autocomplete.hideDropDown()
                            : e.options
                            ? n.autocomplete.show(t, e.startFrom, e.options)
                            : n.autocomplete.show(t, 0, e);
                        })
                        .catch(function(e) {
                          console.error(e);
                        })
          ...
          (t._onKeyDown = function(e) {
            ...
            9 === n &&
              ...
              setTimeout(function() {
                t.focusTarget !== l &&
                  (0, I.selectContentEditable)(t.focusTarget);
              }, 0)),
              this.searchBox &&
                (o && 70 === n
                  ? (this.searchBox.dom.search.focus(),
                    ...
                    (a = !0))
                  : (114 === n || (o && 71 === n)) &&
                    (s ? this.searchBox.previous(!0) : this.searchBox.next(!0),
                    (a = !0))),
              this.history &&
                (o && !s && 90 === n
                  ? (this._onUndo(), (a = !0))
                  : o && s && 90 === n && (this._onRedo(), (a = !0))),
              this.options.autocomplete &&
                !a &&
                (o ||
                  i ||
                  r ||
                  (1 !== e.key.length && 8 !== n && 46 !== n) ||
                  ((a = !1), this._showAutoComplete(e.target))),
              a && (e.preventDefault(), e.stopPropagation());
          }),
          (t._createTable = function() {
            var e;
            this.options.navigationBar &&
              (0, I.addClassName)(this.contentOuter, 'has-nav-bar'),
          ...
          (t.showContextMenu = function(e, t) {
            ...
            i.push({
              ...
              new s.x(i, { close: t }).show(e, this.getPopupAnchor());
          }),
          ...
          (t.getSelection = function() {
            ...
            return (
              this.multiselection.nodes &&
                this.multiselection.nodes.length &&
                this.multiselection.nodes.length &&
                ((e = this.multiselection.nodes[0]),
                (t = this.multiselection.nodes[
                  this.multiselection.nodes.length - 1
                ]),
                'down' === this.multiselection.direction
                  ? ((n.start = e.serialize()), (n.end = t.serialize()))
                  : ((n.start = t.serialize()), (n.end = e.serialize()))),
              n
            );
          }),
          (t.onSelectionChange = function(e) {
            'function' == typeof e &&
              (this._selectionChangedHandler = (0, I.debounce)(
                e,
                this.DEBOUNCE_INTERVAL
              ));
          }),
          ...
          (t._getNodeInstancesByRange = function(e, t) {
            ...
            e &&
              e.path &&
              ((n = this.node.findNodeByPath(e.path)),
              t && t.path && (i = this.node.findNodeByPath(t.path)));
            var o = [];
            if (n instanceof N)
              if (i instanceof N && i !== n)
                if (n.parent === i.parent) {
                  t = n.getIndex() < i.getIndex() ? ((e = n), i) : ((e = i), n);
                  var r = e;
                  for (
                    o.push(r);
                    (r = r.nextSibling()), o.push(r), r && r !== t;
          ...
          (t.getNodesByRange = function(e, t) {
            var t = this._getNodeInstancesByRange(e, t),
              n = [];
            return (
              t.forEach(function(e) {
                n.push(e.serialize());
        ...
        var B = [
          { mode: 'tree', mixin: t, data: 'json' },
          { mode: 'view', mixin: t, data: 'json' },
          { mode: 'form', mixin: t, data: 'json' },
        ];
      },
      744: function(e, t, n) {
      ...
      791: function(e, t, n) {
        ...
        function m(e) {
          (void 0 !== r ? r : JSON).parse(e);
        }
        function f(e, t) {
          for (var n in t) fe(t, n) && (e[n] = t[n]);
          return e;
        }
        function v(e) {
          for (var t in e) fe(e, t) && delete e[t];
          return e;
        }
        function g(e) {
          return null === e
        ...
        var y = /^https?:\/\/\S+$/;
        function b(e) {
          return ('string' == typeof e || e instanceof String) && y.test(e);
        }
        function x(e) {
        ...
        function A(e) {
          ...
          e &&
            window.getSelection &&
            ((t = window.getSelection()).removeAllRanges(), t.addRange(e));
        }
        function D() {
          var e = j();
          return e &&
        ...
        function P(e) {
          ...
          document.createRange &&
            ...
            e.container.firstChild ||
              e.container.appendChild(document.createTextNode('')),
            t.setStart(e.container.firstChild, e.startOffset),
            t.setEnd(e.container.firstChild, e.endOffset),
            A(t));
        }
        function O(e, t) {
          if (
            ...
            var n = e.nodeValue.replace(/\s*\n\s*/g, '');
            return '' !== n ? t.flush() + n : '';
          }
          if (e.hasChildNodes()) {
            for (
              var i = e.childNodes, o = '', r = 0, s = i.length;
              r < s;
              r++
            ) {
              var a,
                l = i[r];
              'DIV' === l.nodeName || 'P' === l.nodeName
                ? ((a = (a = i[r - 1]) ? a.nodeName : void 0) &&
                    'DIV' !== a &&
                    'P' !== a &&
                    'BR' !== a &&
                    ('' !== o && (o += '\n'), t.flush()),
          ...
          return (
            -1 === V &&
              ...
              'undefined' != typeof navigator &&
                ...
                null != /MSIE ([0-9]+[.0-9]+)/.exec(navigator.userAgent) &&
        ...
        function B(e, t, n, i) {
          if (e.addEventListener)
            return (
              void 0 === i && (i = !1),
              'mousewheel' === t && L() && (t = 'DOMMouseScroll'),
          ...
          for (; void 0 !== n[i]; )
            if ('.' === n[i])
              i++,
                e.push(
                  (function() {
                    for (var e = ''; void 0 !== n[i] && /[\w$]/.test(n[i]); )
                      (e += n[i]), i++;
                    if ('' === e)
                      throw new Error(
          ...
          return e
            .map(function(e) {
              return 'number' == typeof e
                ? '[' + e + ']'
                : 'string' == typeof e && e.match(/^[A-Za-z0-9_$]+$/)
                ? '.' + e
                : '["' + e + '"]';
            })
            .join('');
            ...
            'enum' !== e.keyword ||
              ...
              ((n = e.schema) &&
                (5 <
                  ...
                  ((t = ['(' + (n.length - 5) + ' more...)']),
                  (n = n.slice(0, 5)).push(t)),
                (e.message = 'should be equal to one of: ' + n.join(', ')))),
        ...
        function Q(e, t) {
          for (
            var n = t.length, i = 0, o = e.length, r = t.length;
            t.charAt(i) === e.charAt(i) && i < n;

          )
            i++;
          for (; t.charAt(r - 1) === e.charAt(o - 1) && i < r && 0 < o; )
            r--, o--;
        ...
        function Z(t) {
          ...
          return (
            ...
            'number' == typeof t.selectionEnd
              ? ((r = t.selectionStart), (s = t.selectionEnd))
              : (o = document.selection.createRange()) &&
                o.parentElement() === t &&
                ((i = t.value.length),
                (e = t.value.replace(/\r\n/g, '\n')),
                (n = t.createTextRange()).moveToBookmark(o.getBookmark()),
                (o = t.createTextRange()).collapse(!1),
                -1 < n.compareEndPoints('StartToEnd', o)
                  ? (r = s = i)
                  : ((r = -n.moveStart('character', -i)),
                    (r += e.slice(0, r).split('\n').length - 1),
                    -1 < n.compareEndPoints('EndToEnd', o)
                      ? (s = i)
                      : ((s = -n.moveEnd('character', -i)),
                        (s += e.slice(0, s).split('\n').length - 1)))),
            { startIndex: r, endIndex: s, start: a(r), end: a(s) }
          );
          function a(e) {
        ...
        function X(e, t, n) {
          ...
          if (0 < t && 0 < n) {
            e = e.split('\n', t);
            (t = Math.min(e.length, t)), (n = Math.min(e[t - 1].length, n - 1));
            n = 1 === t ? n : n + 1;
        ...
        function ne(n, e) {
          ...
          return (
            ...
            n.default &&
              ...
              (i += JSON.stringify(n.default, null, 2))),
        ...
        function oe(e, t) {
          for (
            var n = e.replace(/ \(copy( \d+)?\)$/, ''), i = n, o = 1;
            -1 !== t.indexOf(i);
        ...
        function re(e, t) {
          var n = {};
          if (Array.isArray(e))
            for (var i = Math.min(e.length, d), o = 0; o < i; o++)
              !(function t(n, i, o, r) {
                ((Array.isArray(n) || ue(n)) && !r) || (i[o || ''] = !0),
                  ue(n) &&
            ...
            var i = (function(t) {
              if (
                !('error' === n[t].type
                  ...
                  : e.find(function(e) {
                      return (
                        e.dataPath === n[t].dataPath &&
                        e.schemaPath === n[t].schemaPath
                      );
                    }))
              )
                return { v: !0 };
            })(t);
            if ('object' === l(i)) return i.v;
          }
          return !1;
        }
        function fe(e, t) {
      ...
      37: function(e, t, n) {
        var i;
        if (window.Picker) i = window.Picker;
        else
          try {
            i = n(
              Object(
        ...
        e.exports = function t(e, n) {
          ...
          var o,
            ...
            u = a
              ...
              .split('\0'),
            e =
              parseInt(e.match(d), 16) ||
              (1 !== h.length && e.match(l) && Date.parse(e)),
            a =
              parseInt(a.match(d), 16) ||
              (e && a.match(l) && Date.parse(a)) ||
              null;
          if (a) {
            if (e < a) return -1;
            if (a < e) return 1;
          }
          for (var p = 0, m = Math.max(h.length, u.length); p < m; p++) {
            if (
              ((o = (!(h[p] || '').match(c) && parseFloat(h[p])) || h[p] || 0),
              (r = (!(u[p] || '').match(c) && parseFloat(u[p])) || u[p] || 0),
              isNaN(o) !== isNaN(r))
            )
              return isNaN(o) ? 1 : -1;
            if ((typeof o != typeof r && ((o += ''), (r += '')), o < r))
              return -1;
            if (r < o) return 1;
          }
          return 0;
      ...
      156: function(e, t) {
        !(function(e) {
          ...
          function S(e, t) {
            ...
            for (i in e)
              if (hasOwnProperty.call(e, i)) {
                if (!1 === S(e[i], t[i])) return !1;
                r[i] = !0;
              }
            for (o in t)
              if (hasOwnProperty.call(t, o) && !0 !== r[o]) return !1;
            return !0;
          }
          function _(e) {
          ...
          i.prototype = {
            tokenize: function(e) {
              ...
              for (this._current = 0; this._current < e.length; )
                if (
                  ('a' <= (i = e[this._current]) && i <= 'z') ||
                  ('A' <= i && i <= 'Z') ||
                  '_' === i
                )
                  (r = this._current),
                    (t = this._consumeUnquotedIdentifier(e)),
                    o.push({ type: h, value: t, start: r });
                else if (void 0 !== M[e[this._current]])
                  o.push({
                    type: M[e[this._current]],
                    value: e[this._current],
                    start: this._current,
                  }),
                    this._current++;
                else if (B(e[this._current]))
                  (n = this._consumeNumber(e)), o.push(n);
                else if ('[' === e[this._current])
                  (n = this._consumeLBracket(e)), o.push(n);
                else if ('"' === e[this._current])
                  (r = this._current),
                    (t = this._consumeQuotedIdentifier(e)),
                    o.push({ type: u, value: t, start: r });
                else if ("'" === e[this._current])
                  (r = this._current),
                    (t = this._consumeRawStringLiteral(e)),
                    o.push({ type: F, value: t, start: r });
                else if ('`' === e[this._current]) {
                  var r = this._current,
                    s = this._consumeLiteral(e);
                  o.push({ type: F, value: s, start: r });
                } else if (void 0 !== V[e[this._current]])
                  o.push(this._consumeOperator(e));
                else if (void 0 !== L[e[this._current]]) this._current++;
                else if ('&' === e[this._current])
                  (r = this._current),
                    this._current++,
                    '&' === e[this._current]
                      ? (this._current++,
                        o.push({ type: 'And', value: '&&', start: r }))
                      : o.push({ type: k, value: '&', start: r });
                else {
                  if ('|' !== e[this._current]) {
                  ...
                  (r = this._current),
                    ...
                    '|' === e[this._current]
                      ? (this._current++,
                        o.push({ type: 'Or', value: '||', start: r }))
                      : o.push({ type: I, value: '|', start: r });
                }
              return o;
            },
            _consumeUnquotedIdentifier: function(e) {
              ...
              for (
                this._current++;
                this._current < e.length &&
                (('a' <= (t = e[this._current]) && t <= 'z') ||
                  ('A' <= t && t <= 'Z') ||
                  ('0' <= t && t <= '9') ||
                  '_' === t);
            ...
            _consumeNumber: function(e) {
              var t = this._current;
              this._current++;
              for (var n = e.length; B(e[this._current]) && this._current < n; )
                this._current++;
              var i = parseInt(e.slice(t, this._current));
              return { type: y, value: i, start: t };
            },
            _consumeLBracket: function(e) {
              ...
              return (
                this._current++,
                '?' === e[this._current]
                  ? (this._current++, { type: x, value: '[?', start: t })
                  : ']' === e[this._current]
                  ? (this._current++, { type: D, value: '[]', start: t })
                  : { type: P, value: '[', start: t }
              );
            },
            _consumeOperator: function(e) {
              ...
              return (
                ...
                '!' === n
                  ...
                  : '<' === n
                  ? '=' === e[this._current]
                    ? (this._current++, { type: A, value: '<=', start: t })
                    : { type: 'LT', value: '<', start: t }
                  : '>' === n
                  ? '=' === e[this._current]
                    ? (this._current++, { type: j, value: '>=', start: t })
            ...
            _consumeLiteral: function(e) {
              this._current++;
              for (
                var t = this._current, n = e.length;
                '`' !== e[this._current] && this._current < n;
              ...
              var t = (t = o(e.slice(t, this._current))).replace('\\`', '`'),
                t = this._looksLikeJSON(t)
                  ? JSON.parse(t)
                  : JSON.parse('"' + t + '"');
          ...
          function J(e) {
            (this._interpreter = e),
              (this.functionTable = {
                abs: { _func: this._functionAbs, _signature: [{ types: [d] }] },
                avg: { _func: this._functionAvg, _signature: [{ types: [a] }] },
                ceil: {
                ...
                contains: {
                  ...
                  _signature: [{ types: [c, s] }, { types: [r] }],
                },
                ends_with: {
                  _func: this._functionEndsWith,
                  _signature: [{ types: [c] }, { types: [c] }],
                },
                floor: {
                ...
                length: {
                  ...
                  _signature: [{ types: [c, s, t] }],
                },
                map: {
                  _func: this._functionMap,
                  _signature: [{ types: [n] }, { types: [s] }],
                },
                max: {
                  _func: this._functionMax,
                  _signature: [{ types: [a, l] }],
                },
                merge: {
                  _func: this._functionMerge,
                  _signature: [{ types: [t], variadic: !0 }],
                },
                max_by: {
                  _func: this._functionMaxBy,
                  _signature: [{ types: [s] }, { types: [n] }],
                },
                sum: { _func: this._functionSum, _signature: [{ types: [a] }] },
                starts_with: {
          ...
          (R.EOF = 0),
            ...
            (z.prototype = {
              parse: function(e) {
                ...
                (e = this._lookaheadToken(0)),
                  (e = new Error(
                    'Unexpected token type: ' + e.type + ', value: ' + e.value
                  ));
                throw ((e.name = 'ParserError'), e);
              },
              _loadTokens: function(e) {
                var t = new i().tokenize(e);
                t.push({ type: 'EOF', value: '', start: e.length }),
                  (this.tokens = t);
              },
              expression: function(e) {
                var t = this._lookaheadToken(0);
                this._advance();
                for (var n = this.nud(t), i = this._lookahead(0); e < R[i]; )
                  this._advance(),
                    (n = this.led(i, n)),
                    (i = this._lookahead(0));
                return n;
              ...
              nud: function(e) {
                ...
                switch (e.type) {
                  ...
                  case 'Not':
                    return {
                      type: 'NotExpression',
                      children: [(t = this.expression(R.Not))],
                    };
                  case b:
                    return (
                      (t = null),
                      {
                        ...
                        children: [
                          ...
                          (t =
                            this._lookahead(0) === p
                              ? { type: 'Identity' }
                              : this._parseProjectionRHS(R.Star)),
                        ],
                      }
                    );
                  case x:
                  ...
                  case D:
                    return {
                      type: 'Projection',
                      children: [
                        { type: D, children: [{ type: 'Identity' }] },
                        (t = this._parseProjectionRHS(R.Flatten)),
                      ],
                    };
                  case P:
                    return this._lookahead(0) === y || this._lookahead(0) === v
                      ? ((t = this._parseIndexExpression()),
                        this._projectIfSlice({ type: 'Identity' }, t))
                      : this._lookahead(0) === b && this._lookahead(1) === p
                      ? (this._advance(),
                        this._advance(),
                        {
                          type: 'Projection',
                          children: [
                            { type: 'Identity' },
                            (t = this._parseProjectionRHS(R.Star)),
                          ],
                        })
                  ...
                  case k:
                    return {
                      ...
                      children: [(n = this.expression(R.Expref))],
                    };
                  case O:
                    for (var o = []; this._lookahead(0) !== m; )
                      this._lookahead(0) === N
                        ? ((n = { type: N }), this._advance())
                        : (n = this.expression(0)),
                        o.push(n);
                    return this._match(m), o[0];
                  default:
                    this._errorToken(e);
                }
              },
              led: function(e, t) {
                ...
                switch (e) {
                  ...
                  case 'And':
                    return {
                      type: 'AndExpression',
                      children: [t, (n = this.expression(R.And))],
                    };
                  case O:
                    for (var o, i = t.name, r = []; this._lookahead(0) !== m; )
                      this._lookahead(0) === N
                        ? ((o = { type: N }), this._advance())
                        : (o = this.expression(0)),
                        this._lookahead(0) === f && this._match(f),
                        r.push(o);
                    return (
                      this._match(m), { type: 'Function', name: i, children: r }
                    );
                  case x:
                      ...
                      this._match(p),
                      {
                        ...
                        children: [
                          ...
                          (n =
                            this._lookahead(0) === D
                              ? { type: 'Identity' }
                              : this._parseProjectionRHS(R.Filter)),
                          s,
                        ],
                      }
                    );
                  case D:
                    return {
                      ...
                      children: [
                        { type: D, children: [t] },
                        this._parseProjectionRHS(R.Flatten),
                      ],
                    };
                  case 'EQ':
                  case 'NE':
                  ...
                  case P:
                    ...
                    return s.type === y || s.type === v
                      ? ((n = this._parseIndexExpression()),
                        this._projectIfSlice(t, n))
                      : (this._match(b),
                        this._match(p),
                        {
                          type: 'Projection',
                          children: [t, (n = this._parseProjectionRHS(R.Star))],
                        });
                  default:
              ...
              _match: function(e) {
                if (this._lookahead(0) !== e) {
                  var t = this._lookaheadToken(0),
                    t = new Error('Expected ' + e + ', got: ' + t.type);
              ...
              _errorToken: function(e) {
                e = new Error(
                  'Invalid token (' + e.type + '): "' + e.value + '"'
                );
                throw ((e.name = 'ParserError'), e);
              },
              _parseIndexExpression: function() {
                if (this._lookahead(0) === v || this._lookahead(1) === v)
              ...
              _projectIfSlice: function(e, t) {
                ...
                return 'Slice' === t.type
                  ? {
                      type: 'Projection',
                      children: [e, this._parseProjectionRHS(R.Star)],
                    }
                  : e;
              },
              _parseSliceExpression: function() {
                for (
                  var e = [null, null, null], t = 0, n = this._lookahead(0);
                  n !== p && t < 3;

                ) {
                  if (n === v) t++, this._advance();
                  else {
                    if (n !== y) {
                      var i = this._lookahead(0),
                        i = new Error(
              ...
              _parseComparator: function(e, t) {
                return {
                  type: 'Comparator',
                  name: t,
                  children: [e, this.expression(R[t])],
                };
              },
              _parseDotRHS: function(e) {
                var t = this._lookahead(0);
                return 0 <= [h, u, b].indexOf(t)
                  ? this.expression(e)
                  : t === P
                  ? (this._match(P), this._parseMultiselectList())
                  : t === T
                  ? (this._match(T), this._parseMultiselectHash())
                  : void 0;
              },
              _parseProjectionRHS: function(e) {
                var t;
                if (R[this._lookahead(0)] < 10) t = { type: 'Identity' };
              ...
              _parseMultiselectList: function() {
                for (var e = []; this._lookahead(0) !== p; ) {
                  ...
                  if (
                    (e.push(t),
                    this._lookahead(0) === f &&
                      (this._match(f), this._lookahead(0) === p))
                  )
              ...
              _parseMultiselectHash: function() {
                for (var e, t, n = [], i = [h, u]; ; ) {
                  if (((t = this._lookaheadToken(0)), i.indexOf(t.type) < 0))
                    throw new Error(
                      'Expecting an identifier token, got: ' + t.type
                    );
                  if (
                    ((e = t.value),
                    this._advance(),
                    this._match(v),
                    (t = this.expression(0)),
                    n.push({ type: 'KeyValuePair', name: e, value: t }),
                    this._lookahead(0) === f)
                  )
                    this._match(f);
                  else if (this._lookahead(0) === g) {
                    this._match(g);
                    break;
                  }
                }
            ...
            (H.prototype = {
              ...
              visit: function(e, t) {
                ...
                switch (e.type) {
                  case 'Field':
                    return null === t || !w(t) || void 0 === (l = t[e.name])
                      ? null
                      : l;
                  case 'Subexpression':
                    for (
                      h = this.visit(e.children[0], t), f = 1;
                      f < e.children.length;
                      f++
                    )
                      if (null === (h = this.visit(e.children[1], h)))
                        return null;
                    return h;
                  case 'IndexExpression':
                    return (
                      (T = this.visit(e.children[0], t)),
                      this.visit(e.children[1], T)
                    );
                  case 'Index':
                    if (!E(t)) return null;
                    var a = e.value;
                    return (h =
                      void 0 === (h = t[(a = a < 0 ? t.length + a : a)])
                        ? null
                        : h);
                  case 'Slice':
                    if (!E(t)) return null;
                    var l = e.children.slice(0),
                      a = this.computeSliceParams(t.length, l),
                      l = a[0],
                      d = a[1],
                      c = a[2],
                      h = [];
                    if (0 < c) for (f = l; f < d; f += c) h.push(t[f]);
                    else for (f = l; d < f; f += c) h.push(t[f]);
                    return h;
                  case 'Projection':
                    var u = this.visit(e.children[0], t);
                    if (!E(u)) return null;
                    for (p = [], f = 0; f < u.length; f++)
                      null !== (i = this.visit(e.children[1], u[f])) &&
                        p.push(i);
                    return p;
                  case 'ValueProjection':
                    ...
                    for (
                      ...
                      null !== (i = this.visit(e.children[1], m[f])) &&
                        p.push(i);
                    return p;
                  case 'FilterProjection':
                    if (!E((u = this.visit(e.children[0], t)))) return null;
                    var v = [],
                      g = [];
                    for (f = 0; f < u.length; f++)
                      _((n = this.visit(e.children[2], u[f]))) || v.push(u[f]);
                    for (var y = 0; y < v.length; y++)
                      null !== (i = this.visit(e.children[1], v[y])) &&
                        g.push(i);
                    return g;
                  case 'Comparator':
                    switch (
                      ((o = this.visit(e.children[0], t)),
                      (r = this.visit(e.children[1], t)),
                      e.name)
                    ) {
                      case 'EQ':
                        h = S(o, r);
                    ...
                    return h;
                  case D:
                    var b = this.visit(e.children[0], t);
                    if (!E(b)) return null;
                    var x = [];
                    for (f = 0; f < b.length; f++)
                      E((i = b[f])) ? x.push.apply(x, i) : x.push(i);
                    return x;
                  case 'Identity':
                    return t;
                  ...
                  case 'MultiSelectHash':
                    if (null === t) return null;
                    for (p = {}, f = 0; f < e.children.length; f++)
                      p[(s = e.children[f]).name] = this.visit(s.value, t);
                    return p;
                  case 'OrExpression':
                    return (n = _((n = this.visit(e.children[0], t)))
                      ? this.visit(e.children[1], t)
                      : n);
                  case 'AndExpression':
                    return !0 === _((o = this.visit(e.children[0], t)))
                      ? o
                      : this.visit(e.children[1], t);
                  case 'NotExpression':
                    return _((o = this.visit(e.children[0], t)));
                  case 'Literal':
                    return e.value;
                  case I:
                    return (
                  ...
                  case 'Function':
                    ...
                    for (f = 0; f < e.children.length; f++)
                      C.push(this.visit(e.children[f], t));
                    return this.runtime.callFunction(e.name, C);
                  case 'ExpressionReference':
                    var T = e.children[0];
                    return (T.jmespathType = k), T;
                  default:
              ...
              computeSliceParams: function(e, t) {
                ...
                if (null === o) o = 1;
                  ...
                  var r = new Error('Invalid slice, step cannot be 0');
                  throw ((r.name = 'RuntimeError'), r);
                }
                (r = o < 0),
                  (n =
                    null === n ? (r ? e - 1 : 0) : this.capSliceRange(e, n, o)),
                  (i = null === i ? (r ? -1 : e) : this.capSliceRange(e, i, o));
                return (t[0] = n), (t[1] = i), (t[2] = o), t;
              },
            ...
            (J.prototype = {
              callFunction: function(e, t) {
                ...
                return (
                  this._validateArgs(e, t, n._signature), n._func.call(this, t)
                );
              },
              _validateArgs: function(e, t, n) {
                ...
                if (n[n.length - 1].variadic) {
                  if (t.length < n.length)
                    throw ((i = 1 === n.length ? ' argument' : ' arguments'),
                    new Error(
                      'ArgumentError: ' +
                        e +
                        '() takes at least' +
                ...
                for (var o = 0; o < n.length; o++) {
                  for (
                    var r = !1,
                      s = n[o].types,
                      a = this._getTypeName(t[o]),
                      l = 0;
                    l < s.length;
                    l++
                  )
                    if (this._typeMatches(a, s[l], t[o])) {
                      r = !0;
                      break;
                    }
                  if (!r)
              ...
              _typeMatches: function(e, t, n) {
                if (t === r) return !0;
                if (t !== l && t !== a && t !== s) return e === t;
                if (t === s) return e === s;
                if (e === s) {
                  var i;
                  t === a ? (i = d) : t === l && (i = c);
                  for (var o = 0; o < n.length; o++)
                    if (!this._typeMatches(this._getTypeName(n[o]), i, n[o]))
                      return !1;
                  return !0;
                }
              },
              ...
              _functionReverse: function(e) {
                if (this._getTypeName(e[0]) === c) {
                  for (var t = e[0], n = '', i = t.length - 1; 0 <= i; i--)
                    n += t[i];
                  return n;
                }
                e = e[0].slice(0);
              ...
              _functionLength: function(e) {
                return (w(e[0]) ? Object.keys(e[0]) : e[0]).length;
              },
              _functionMap: function(e) {
                for (
                  var t = [], n = this._interpreter, i = e[0], o = e[1], r = 0;
                  r < o.length;
                  r++
                )
                  t.push(n.visit(i, o[r]));
                return t;
              },
              ...
              _functionMax: function(e) {
                if (0 < e[0].length) {
                  if (this._getTypeName(e[0][0]) === d)
                    return Math.max.apply(Math, e[0]);
                  for (var t = e[0], n = t[0], i = 1; i < t.length; i++)
                    n.localeCompare(t[i]) < 0 && (n = t[i]);
                  return n;
                }
                return null;
              },
              ...
              _functionValues: function(e) {
                for (
                  var t = e[0], n = Object.keys(t), i = [], o = 0;
                  o < n.length;
                  o++
                )
                  i.push(t[n[o]]);
              ...
              _functionToArray: function(e) {
                return this._getTypeName(e[0]) === s ? e[0] : [e[0]];
              },
              _functionToString: function(e) {
                return this._getTypeName(e[0]) === c
                  ? e[0]
                  : JSON.stringify(e[0]);
              },
              _functionToNumber: function(e) {
                var t,
                  n = this._getTypeName(e[0]);
                return n === d
                  ? e[0]
                  : n !== c || ((t = +e[0]), isNaN(t))
                  ? null
              ...
              _functionSortBy: function(e) {
                ...
                if ([d, c].indexOf(s) < 0) throw new Error('TypeError');
                for (var a = this, n = [], i = 0; i < t.length; i++)
                  n.push([i, t[i]]);
                n.sort(function(e, t) {
                  var n = o.visit(r, e[1]),
                    i = o.visit(r, t[1]);
              ...
              _functionMaxBy: function(e) {
                for (
                  var t,
                    ...
                    i = e[1],
                    o = e[0],
                    r = this.createKeyFunction(i, [d, c]),
                    s = -1 / 0,
                    a = 0;
                  a < o.length;
                  a++
              ...
              createKeyFunction: function(n, i) {
                ...
                return function(e) {
                  var t = r.visit(n, e);
                  if (i.indexOf(o._getTypeName(t)) < 0) {
                    e =
            ...
            (e.search = function(e, t) {
              var n = new z(),
                i = new J(),
                o = new H(i);
              return (i._interpreter = o), (t = n.parse(t)), o.search(t, e);
            }),
            (e.strictDeepEqual = S);
        })(t);
      },
      26: function(e, t) {
        ...
        var C = {
          ...
          T = 'a'.charCodeAt();
        (t.parse = function(o, e, t) {
          var i = {},
            n = 0,
            r = 0,
            s = 0,
            a = t && t.bigint && 'undefined' != typeof BigInt;
          return { data: l('', !0), pointers: i };
          function l(e, t) {
            var n;
            d(), f(e, 'value');
            var i = u();
            ...
            return f(e, 'valueEnd'), d(), t && s < o.length && y(), n;
          }
          function d() {
            e: for (; s < o.length; ) {
              switch (o[s]) {
          ...
          function h(e) {
            for (var t = 0; t < e.length; t++) u() !== e[t] && b();
          }
          function u() {
            x();
            var e = o[s];
          ...
          function g() {
            return { line: n, column: r, pos: s };
          }
          function y() {
            throw new SyntaxError(
              'Unexpected token ' + o[s] + ' in JSON at position ' + s
            );
          }
          function b() {
            p(), y();
          ...
          (t.stringify = function(e, t, n) {
              ...
              return (
                (function l(d, c, h) {
                  ...
                  switch (typeof d) {
                    ...
                    case 'object':
                      null === d
                        ...
                        ? e()
                        : m
                        ? d.constructor.BYTES_PER_ELEMENT
                          ? e()
                          : d instanceof Map
                          ? n()
                          : d instanceof Set
                  ...
                  function e() {
                    if (d.length) {
                      f('[');
                      for (var e = c + 1, t = 0; t < d.length; t++) {
                        t && f(','), v(e);
                        var n = b(d[t]) ? d[t] : null,
                          i = h + '/' + t;
                        l(n, e, i);
                      }
                      v(c), f(']');
                  ...
                  function t() {
                    ...
                    if (e.length) {
                      f('{');
                      for (var t = c + 1, n = 0; n < e.length; n++) {
                        var i,
                          o = e[n],
                          r = d[o];
                        b(r) &&
                  ...
                  function n(e) {
                    if (d.size) {
                      f('{');
                      for (
                        var t = c + 1, n = !0, i = d.entries(), o = i.next();
                        !o.done;
            ...
            function g(e, t) {
              (d[e] = d[e] || {}), (d[e][t] = { line: c, column: h, pos: p });
            }
            function y(e, t) {
        ...
        var d = /~/g,
          c = /\//g;
        function E(e) {
          return e.replace(d, '~0').replace(c, '~1');
        }
      },
      664: function(e) {
        e.exports = (function() {
          ...
          function r(e, t) {
            ...
            (this.message = e + ' (char ' + t + ')'),
              (this.char = t),
              (this.stack = new Error().stack);
          }
          (r.prototype = new Error()).constructor = Error;
          var s = { "'": !0, '‘': !0, '’': !0, '`': !0, '´': !0 },
            a = { '"': !0, '“': !0, '”': !0 };
          function l(e) {
            return t.test(e);
          ...
          var o = 0,
            ...
            S = { null: 'null', true: 'true', false: 'false' },
            _ = { None: 'null', True: 'true', False: 'false' },
            N = '',
            k = '',
            I = 0,
            j = '',
              ...
              T[j]
                ...
                : (function() {
                    if (c(j) || '-' === j) {
                      if (((D = v), '-' === j)) {
                        if (((A += j), P(), !c(j)))
                          throw new r('Invalid number, digit expected', I);
                      } else '0' === j && ((A += j), P());
                      for (; c(j); ) (A += j), P();
                      if ('.' === j) {
                        if (((A += j), P(), !c(j)))
          ...
          function V(e) {
            if (!0 === s[(t = j)] || !0 === a[t]) {
              ...
              for (A += '"', D = g, e(); '' !== j && !n(j); )
                if ('\\' === j)
                  if ((e(), void 0 !== E[j])) (A += '\\' + j), e();
                  else if ('u' === j) {
                    (A += '\\u'), e();
                    for (var i = 0; i < 4; i++) {
                      if (((o = j), !d.test(o)))
                        throw new r('Invalid unicode character', I - A.length);
                      (A += j), e();
                    }
                  } else {
                    if ("'" !== j)
                      throw new r('Invalid escape character "\\' + j + '"', I);
                    (A += "'"), e();
                  }
                else w[j] ? (A += w[j]) : (A += '"' === j ? '\\"' : j), e();
              if (f(j) !== t)
                throw new r('End of string expected', I - A.length);
              return (A += '"'), void e();
            }
            var o, t;
            !(function() {
              if (l(j)) for (D = y; l(j) || c(j) || '$' === j; ) (A += j), P();
              else
                !(function() {
                  if (h(j) || u(j)) for (D = b; h(j) || u(j); ) (A += j), P();
                  else
                    !(function() {
                      if ('/' !== j || '*' !== N[I + 1])
                        if ('/' !== j || '/' !== N[I + 1])
          ...
          function L() {
            if (D !== o || '{' !== A)
                    ...
                    if (D !== g)
                      ...
                      for (M(); D === o && '+' === A; ) {
                        ...
                        (A = ''),
                          ...
                          D === g &&
                            ((e = k.lastIndexOf('"')),
                            (k = k.substring(0, e) + A.substring(1)),
                            (A = ''),
                            M());
                      }
                  })();
              ...
              for (;;) {
                if (
                  ((D !== y && D !== v) || ((D = g), (A = '"'.concat(A, '"'))),
                  D !== g)
                )
                  throw new r('Object key expected', I - A.length);
                if ((M(), D === o && ':' === A)) M();
                else {
                  if (!F()) throw new r('Colon expected', I - A.length);
                  k = i(k, ':');
                }
                if ((L(), D === o && ',' === A)) {
                  if ((M(), D === o && '}' === A)) {
          ...
          return function(e) {
            if (
              ...
              return k;
            if (e && F()) {
              for (var t = ''; F(); ) (t += k = i(k, ',')), (k = ''), L();
              return '[\n'.concat(t).concat(k, '\n]');
            }
            throw new r('Unexpected characters', I - A.length);
          };
        })();
      },
      483: function(e, t) {
            ...
            void 0 ===
              (i =
                ...
                typeof (i = function() {
                  'use strict';
                  function g(e) {
                    if (typeof Node === 'object') return e instanceof Node;
                    else
                      return (
                        e &&
                        typeof e === 'object' &&
                  ...
                  function x(e, t) {
                    return r
                      ...
                      .stylize(
                        e('overlayStyles', { opacity: 0.5, background: '#000' })
                      )
                      .onClick(function() {
                  ...
                  (r.make = function(e, t) {
                    ...
                    (r.prototype = {
                      ...
                      stylize: function(e) {
                        ...
                        for (var t in e)
                          if (e.hasOwnProperty(t)) this.elem.style[t] = e[t];
                        return this;
                      },
                      clazz: function(e) {
                      ...
                      html: function(e) {
                        if (g(e)) this.elem.appendChild(e);
                        else this.elem.innerHTML = e;
                        return this;
                      },
                      onClick: function(e) {
                  ...
                  function C(e, n) {
                    ...
                    var o = r
                      ...
                      .attr('id', i)
                      .attr('role', 'dialog')
                      .attr('aria-labelledby', e('ariaLabelledBy'))
                      .attr('aria-describedby', e('ariaDescribedBy', i))
                      .onClick(function(e) {
                  ...
                  function _(e, t) {
                    ...
                    e.beforeShow(function() {
                      ...
                      if (t()) i.stylize({ overflow: 'hidden' });
                    });
                    e.afterClose(function() {
                      i.stylize({ overflow: n });
                    });
                  }
                  return (
                    document.documentElement.addEventListener(
                      ...
                      function e(t) {
                        ...
                        if (n === 27) w.trigger();
                        else if (n === 9) d.trigger(t);
                      }
                    ),
                    function e(i) {
                      if (y(i) || g(i)) i = { content: i };
                      var o = b();
                      var t = b();
                      var n = b();
                      var r = b();
                      ...
                      var l = v.bind(window, 'modal');
                      var d = v.bind(window, 'overlay');
                      var c = v.bind(window, 'close');
                      var h;
                      function u(e) {
                        d().hide();
                        l().hide();
                      ...
                      function v(e, t) {
                        if (!f) {
                          var n = C(a, p);
                          f = { modal: n, overlay: x(a, p), close: T(n, a) };
                          o.trigger(h, t);
                        }
                        return f[e];
                      }
                      h = {
                        ...
                        closeElem: E(c),
                        overlayElem: E(d),
                        buildDom: m(v.bind(null, null)),
                        isVisible: function() {
                          return !!(f && l && l().isVisible());
                        },
                        show: function(e) {
                          if (t.trigger(h, e)) {
                            d().show();
                        ...
                        afterCreate: m(o.watch),
                        beforeShow: m(t.watch),
                        afterShow: m(n.watch),
                        beforeClose: m(r.watch),
                        afterClose: m(s.watch),
                      };
                      S(h, a.bind(null, 'focus', true));
                      _(h, a.bind(null, 'bodyOverflow', true));
                      w.watch(function e() {
                        if (a('escCloses', true) && h.isVisible()) h.close();
                      });
                      return h;
                    }
                  );
