...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 743584,
    DYNAMIC_BASE = 5986464,
    DYNAMICTOP_PTR = 743392;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 743488, 4), 743488);function _gmtime_r(time, tmPtr) {
...
var real__mono_wasm_enable_on_demand_gc = asm["mono_wasm_enable_on_demand_gc"];
asm["mono_wasm_enable_on_demand_gc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__mono_wasm_enable_on_demand_gc.apply(null, arguments);
};
...
var real__putchar = asm["putchar"];
asm["putchar"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var real_dynCall_if = asm["dynCall_if"];
asm["dynCall_if"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
